...
//             if (diff > 1000000) { // movement threshold
//                 moveCount++;
//                 if (moveCount === 1) {
...
//                 } else if (moveCount === 3) {
//                     alert("⚠️ Alert 3: Test service is restart");
//                     restartTest();
//                 }
//             }
//         }
...
//     moveCount = 0;
//     currentQuestion = 0;
//     questions.forEach(q => { q.attempted = false; q.selected = null; });
//     loadQuestion(currentQuestion);
...
//     loadQuestion(currentQuestion);
//     startTimer();
//     startCamera(); // 🚀 Camera auto start with quiz
// };
...
//         video.style.borderRadius = "50%"; // circle
...
//             }
//             const movement = diff / imageData.data.length;
...
//     }
//     const videoEl = document.getElementById("test-camera");
//     if (videoEl) videoEl.remove();
//     currentQuestion = 0;
//     loadQuestion(currentQuestion);
//     startCamera(); // restart camera too
// }
...
//     loadQuestion(currentQuestion);
//     startTimer();
//     startCamera(); // 🚀 Test ke sath camera bhi start
// };
/////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////
...
//     video.style.position = "fixed";
//     video.style.top = "20px";
//     video.style.left = "20px"; // ✅ Left side corner
//     video.style.width = "150px";
//     video.style.height = "150px";
//     video.style.borderRadius = "50%"; // ✅ Circle
//     video.style.border = "3px solid red";
//     video.style.objectFit = "cover"; // ✅ Responsive circle
//     video.style.zIndex = "9999";
//     document.body.appendChild(video);
...
//     video.style.objectFit = "cover";
//     video.style.zIndex = "9999";
//     video.style.cursor = "move"; // ✅ show move cursor

//     document.body.appendChild(video);

//     // ✅ Make camera draggable (movable)
//     makeDraggable(video);
...
// // ✅ Function to make video movable
...
//     loadQuestion(currentQuestion);
//     startTimer();
//     startCamera(); // ✅ camera movable ke sath start
// };
////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
...
//     video.style.objectFit = "cover";
//     video.style.zIndex = "9999";
//     video.style.cursor = "grab"; // 👈 show grab cursor
...
//             if (diff > 1000000) {
//                 movementCount++;
//                 if (movementCount === 1) alert("⚠️ Alert 1: Face is not move");
//                 else if (movementCount === 2) alert("⚠️ Alert 2: Head is not move");
//                 else if (movementCount === 3) {
//                     alert("⚠️ Alert 3: Test series is restarting...");
//                     restartTest();
//                 }
