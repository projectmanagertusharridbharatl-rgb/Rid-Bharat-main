const questions = [
{
  ...
  },
   {
    ...
    question_hi: "निम्नलिखित में से कौन एक इनपुट डिवाइस है?",
  ...
  {
    num: 3,
    question_en: "Which memory is known as volatile memory?",
    question_hi: "कौन सी मेमोरी वोलाटाइल मेमोरी कहलाती है?",
  ...
  },
  {
    ...
    options_en: ["Central Processing Unit", "Computer Personal Unit", "Central Print Unit", "Control Processing Unit"],
    options_hi: ["सेंट्रल प्रोसेसिंग यूनिट", "कंप्यूटर पर्सनल यूनिट", "सेंट्रल प्रिंट यूनिट", "कंट्रोल प्रोसेसिंग यूनिट"],
  ...
  },
  {
    ...
    options_en: ["Windows", "Linux", "Oracle", "MacOS"],
    options_hi: ["विंडोज़", "लिनक्स", "ओरेकल", "मैकओएस"],
    answer_en: "Oracle",
    answer_hi: "ओरेकल",
    attempted: false,
    selected: ""
  ...
  {
    num: 6,
    question_en: "Which component is the brain of the computer?",
    question_hi: "कंप्यूटर का मस्तिष्क कौन सा घटक है?",
    options_en: ["Monitor", "CPU", "Mouse", "Hard Disk"],
    options_hi: ["मॉनिटर", "सीपीयू", "माउस", "हार्ड डिस्क"],
    answer_en: "CPU",
    answer_hi: "सीपीयू",
    attempted: false,
    selected: ""
  },
  {
    ...
    question_hi: "दस्तावेज़ों को प्रिंट करने के लिए कौन सा उपकरण प्रयोग होता है?",
    options_en: ["Scanner", "Printer", "Keyboard", "Monitor"],
    options_hi: ["स्कैनर", "प्रिंटर", "कीबोर्ड", "मॉनिटर"],
    answer_en: "Printer",
    answer_hi: "प्रिंटर",
    attempted: false,
    selected: ""
  },
  {
    ...
    options_en: ["World Web Wide", "Wide World Web", "World Wide Web", "Web World Wide"],
    options_hi: ["वर्ल्ड वेब वाइड", "वाइड वर्ल्ड वेब", "वर्ल्ड वाइड वेब", "वेब वर्ल्ड वाइड"],
  ...
  },
  {
    ...
    question_hi: "कर्सर के बाईं ओर के अक्षरों को हटाने के लिए कौन सी कुंजी प्रयोग होती है?",
    options_en: ["Delete", "Backspace", "Shift", "Esc"],
    options_hi: ["डिलीट", "बैकस्पेस", "शिफ्ट", "एस्केप"],
    answer_en: "Backspace",
    answer_hi: "बैकस्पेस",
    attempted: false,
    selected: ""
  ...
  {
    num: 10,
    question_en: "Which among these is a web browser?",
    question_hi: "इनमें से कौन एक वेब ब्राउज़र है?",
    options_en: ["Google", "Bing", "Yahoo", "Firefox"],
    options_hi: ["गूगल", "बिंग", "याहू", "फायरफॉक्स"],
    answer_en: "Firefox",
    answer_hi: "फायरफॉक्स",
    attempted: false,
    selected: ""
  ...
  {
    num: 11,
    question_en: "Which part of the computer is used for data storage?",
    question_hi: "कंप्यूटर का कौन सा भाग डेटा संग्रहण के लिए उपयोग होता है?",
    options_en: ["CPU", "Monitor", "Hard Disk", "Mouse"],
    options_hi: ["सीपीयू", "मॉनिटर", "हार्ड डिस्क", "माउस"],
    answer_en: "Hard Disk",
  ...
  },
  {
    ...
    question_hi: "सिस्टम सॉफ़्टवेयर का एक उदाहरण क्या है?",
    options_en: ["MS Word", "Tally", "Windows", "Photoshop"],
    options_hi: ["एमएस वर्ड", "टैली", "विंडोज़", "फोटोशॉप"],
    answer_en: "Windows",
    answer_hi: "विंडोज़",
    attempted: false,
    selected: ""
  },
  {
    ...
    question_hi: "Windows ऑपरेटिंग सिस्टम किस कंपनी द्वारा विकसित किया गया?",
    options_en: ["Apple", "Microsoft", "Google", "IBM"],
    options_hi: ["एपल", "माइक्रोसॉफ्ट", "गूगल", "आईबीएम"],
    answer_en: "Microsoft",
  ...
  },
  {
    ...
    question_hi: "वेब पेज को रीफ्रेश करने के लिए कौन सी कुंजी प्रयोग होती है?",
    options_en: ["F2", "F5", "F9", "F12"],
    options_hi: ["F2", "F5", "F9", "F12"],
    answer_en: "F5",
    answer_hi: "F5",
    attempted: false,
    selected: ""
  ...
  {
    num: 15,
    question_en: "Which language is used to design web pages?",
    question_hi: "वेब पेज डिज़ाइन करने के लिए कौन सी भाषा प्रयोग की जाती है?",
    options_en: ["HTML", "C", "Python", "Java"],
    options_hi: ["एचटीएमएल", "सी", "पाइथन", "जावा"],
    answer_en: "HTML",
    answer_hi: "एचटीएमएल",
    attempted: false,
    selected: ""
  ...
  {
    num: 16,
    question_en: "Which device is used to scan images or documents?",
    question_hi: "चित्र या दस्तावेज़ स्कैन करने के लिए कौन सा डिवाइस प्रयोग होता है?",
    options_en: ["Printer", "Scanner", "Mouse", "Monitor"],
    options_hi: ["प्रिंटर", "स्कैनर", "माउस", "मॉनिटर"],
    answer_en: "Scanner",
    answer_hi: "स्कैनर",
    attempted: false,
    selected: ""
...
},
{
  ...
  },
  {
    ...
    options_en: ["Jawaharlal Nehru", "Mahatma Gandhi", "Sardar Patel", "Dr. B.R. Ambedkar"],
    options_hi: ["जवाहरलाल नेहरू", "महात्मा गांधी", "सरदार पटेल", "डॉ. बी.आर. अंबेडकर"],
