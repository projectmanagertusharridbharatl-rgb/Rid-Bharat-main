...
//////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////
// 50 UP Board Sanskrit Questions - One Page JS
const questions = [
  {
    num: 1,
    question_en: "Who is known as the Adi Kavi of Sanskrit literature?",
    question_hi: "संस्कृत साहित्य के आदि कवि के रूप में किसे जाना जाता है?",
    options_en: ["Kalidasa", "Valmiki", "Bharavi", "Bhasa"],
    options_hi: ["कालिदास", "वाल्मीकि", "भारवि", "भास"],
    answer_en: "Valmiki",
    answer_hi: "वाल्मीकि",
    attempted: false,
    selected: ""
  ...
  {
    num: 2,
    question_en: "Which is the famous work of Kalidasa?",
    question_hi: "कालिदास का प्रसिद्ध कार्य कौन सा है?",
    options_en: ["Meghaduta", "Ramayana", "Mahabharata", "Bhagavad Gita"],
    options_hi: ["मेघदूत", "रामायण", "महाभारत", "भगवद गीता"],
    answer_en: "Meghaduta",
    answer_hi: "मेघदूत",
    attempted: false,
    selected: ""
  ...
  {
    num: 3,
    question_en: "What is the meaning of 'Dhatu' in Sanskrit grammar?",
    question_hi: "संस्कृत व्याकरण में 'धातु' का क्या अर्थ है?",
    options_en: ["Root word", "Suffix", "Prefix", "Sentence"],
    options_hi: ["धातु (मूल शब्द)", "प्रत्यय", "उपसर्ग", "वाक्य"],
    answer_en: "Root word",
    answer_hi: "धातु (मूल शब्द)",
    attempted: false,
    selected: ""
  },
  {
    num: 4,
    question_en: "Which Sanskrit poet wrote 'Nagananda'?",
    question_hi: "'नागानन्द' किस संस्कृत कवि ने लिखा?",
    options_en: ["Harsha", "Kalidasa", "Bhasa", "Bharavi"],
    options_hi: ["हर्ष", "कालिदास", "भास", "भारवि"],
    answer_en: "Bhasa",
    answer_hi: "भास",
    attempted: false,
    selected: ""
  ...
  {
    num: 5,
    question_en: "Which is a type of Sanskrit drama?",
    question_hi: "संस्कृत नाटक का कौन सा प्रकार है?",
    options_en: ["Nataka", "Kavya", "Gatha", "Sloka"],
    options_hi: ["नाटक", "काव्य", "गाथा", "श्लोक"],
    answer_en: "Nataka",
    answer_hi: "नाटक",
    attempted: false,
    selected: ""
  ...
  {
    num: 6,
    question_en: "Who wrote 'Mudrarakshasa'?",
    question_hi: "'मुद्राराक्षस' किसने लिखा?",
    options_en: ["Bhasa", "Kalidasa", "Bhavabhuti", "Bharavi"],
    options_hi: ["भास", "कालिदास", "भावभूति", "भारवि"],
    answer_en: "Bhasa",
    answer_hi: "भास",
    attempted: false,
    selected: ""
  ...
  {
    num: 7,
    question_en: "What is 'Samas' in Sanskrit grammar?",
    question_hi: "संस्कृत व्याकरण में 'समास' क्या है?",
    options_en: ["Compound word", "Verb", "Noun", "Adjective"],
    options_hi: ["समास (संयुक्त शब्द)", "क्रिया", "संज्ञा", "विशेषण"],
    answer_en: "Compound word",
    answer_hi: "समास (संयुक्त शब्द)",
    attempted: false,
    selected: ""
  },
  {
    num: 8,
    question_en: "Which Veda contains knowledge of rituals?",
    question_hi: "कौन सा वेद कर्मकांड का ज्ञान देता है?",
    options_en: ["Yajurveda", "Rigveda", "Samaveda", "Atharvaveda"],
    options_hi: ["यजुर्वेद", "ऋग्वेद", "सामवेद", "अथर्ववेद"],
    answer_en: "Yajurveda",
    answer_hi: "यजुर्वेद",
    attempted: false,
    selected: ""
  ...
  {
    num: 9,
    question_en: "Who is the author of 'Uttararama Charita'?",
    question_hi: "'उत्तररामचरित' के लेखक कौन हैं?",
    options_en: ["Bhavabhuti", "Kalidasa", "Bharavi", "Valmiki"],
    options_hi: ["भावभूति", "कालिदास", "भारवि", "वाल्मीकि"],
  ...
  {
    num: 10,
    question_en: "What is 'Pada' in Sanskrit grammar?",
    question_hi: "संस्कृत व्याकरण में 'पद' क्या है?",
    options_en: ["Word", "Sentence", "Verse", "Letter"],
    options_hi: ["शब्द", "वाक्य", "छंद", "अक्षर"],
    answer_en: "Word",
    answer_hi: "शब्द",
    attempted: false,
    selected: ""
  ...
  {
    num: 11,
    question_en: "Which Sanskrit poet wrote 'Shishupala Vadha'?",
    question_hi: "'शिशुपालवध' किसने लिखा?",
    options_en: ["Magha", "Bharavi", "Kalidasa", "Bhavabhuti"],
    options_hi: ["माघ", "भारवि", "कालिदास", "भावभूति"],
    answer_en: "Bharavi",
    answer_hi: "भारवि",
    attempted: false,
    selected: ""
  ...
  {
    num: 12,
    question_en: "Which is the famous work of Magha?",
    question_hi: "माघ का प्रसिद्ध काव्य कौन सा है?",
    options_en: ["Shishupala Vadha", "Raghuvamsha", "Meghaduta", "Abhijnanasakuntalam"],
    options_hi: ["शिशुपालवध", "रघुवंश", "मेघदूत", "अभिज्ञानशाकुन्तलम्"],
    answer_en: "Shishupala Vadha",
    answer_hi: "शिशुपालवध",
    attempted: false,
    selected: ""
  },
  {
    num: 13,
    question_en: "Who is known as 'Kavi Kokila'?",
    question_hi: "कवि कोकिल के नाम से किसे जाना जाता है?",
    options_en: ["Kalidasa", "Bharavi", "Magha", "Bhavabhuti"],
    options_hi: ["कालिदास", "भारवि", "माघ", "भावभूति"],
    answer_en: "Kalidasa",
    answer_hi: "कालिदास",
    attempted: false,
    selected: ""
  ...
  {
    num: 14,
    question_en: "What is 'Vibhakti' in Sanskrit grammar?",
    question_hi: "संस्कृत व्याकरण में 'विभक्ति' क्या है?",
    options_en: ["Case", "Verb", "Tense", "Mood"],
    options_hi: ["कारक", "क्रिया", "काल", "वाच्य"],
    answer_en: "Case",
    answer_hi: "कारक",
    attempted: false,
    selected: ""
  },
  {
    ...
    question_hi: "'अभिज्ञानशाकुन्तलम्' किसने लिखा?",
    options_en: ["Kalidasa", "Bhasa", "Bhavabhuti", "Bharavi"],
    options_hi: ["कालिदास", "भास", "भावभूति", "भारवि"],
    answer_en: "Kalidasa",
    answer_hi: "कालिदास",
    attempted: false,
    selected: ""
  ...
  {
    num: 16,
    question_en: "Which epic is attributed to Valmiki?",
    question_hi: "वाल्मीकि को कौन सा महाकाव्य लिखा माना जाता है?",
    options_en: ["Ramayana", "Mahabharata", "Bhagavad Gita", "Meghaduta"],
    options_hi: ["रामायण", "महाभारत", "भगवद गीता", "मेघदूत"],
    answer_en: "Ramayana",
    answer_hi: "रामायण",
    attempted: false,
    selected: ""
  ...
  {
    num: 17,
    question_en: "What is 'Sandhi' in Sanskrit grammar?",
    question_hi: "संस्कृत व्याकरण में 'संधि' क्या है?",
    options_en: ["Joining of words", "Compound word", "Verb", "Noun"],
    options_hi: ["शब्दों का मिलन", "संयुक्त शब्द", "क्रिया", "संज्ञा"],
    answer_en: "Joining of words",
    answer_hi: "शब्दों का मिलन",
    attempted: false,
    selected: ""
  },
  {
    num: 18,
    question_en: "Which is considered the first Sanskrit drama?",
    question_hi: "पहला संस्कृत नाटक कौन सा माना जाता है?",
    options_en: ["Nagananda", "Mrichchhakatika", "Abhijnanasakuntalam", "Mudrarakshasa"],
    options_hi: ["नागानन्द", "मृच्छकटिक", "अभिज्ञानशाकुन्तलम्", "मुद्राराक्षस"],
    answer_en: "Mrichchhakatika",
    answer_hi: "मृच्छकटिक",
    attempted: false,
    selected: ""
  },
  {
    num: 19,
    question_en: "Which Veda contains hymns?",
    question_hi: "कौन सा वेद स्तोत्रों (संगीत) का संग्रह है?",
  ...
  {
    num: 20,
    question_en: "Who wrote 'Malatimadhava'?",
    question_hi: "'मालतीमाधव' किसने लिखा?",
    options_en: ["Bhavabhuti", "Kalidasa", "Bharavi", "Bhasa"],
    options_hi: ["भावभूति", "कालिदास", "भारवि", "भास"],
    answer_en: "Bhavabhuti",
    answer_hi: "भावभूति",
    attempted: false,
    selected: ""
  ...
  {
    num: 21,
    question_en: "Which Sanskrit poet is famous for 'Raghuvamsha'?",
    question_hi: "'रघुवंश' किस संस्कृत कवि द्वारा लिखा गया?",
    options_en: ["Kalidasa", "Bharavi", "Magha", "Bhavabhuti"],
    options_hi: ["कालिदास", "भारवि", "माघ", "भावभूति"],
    answer_en: "Kalidasa",
    answer_hi: "कालिदास",
  ...
  {
    num: 22,
    question_en: "What is 'Kavya' in Sanskrit?",
    question_hi: "संस्कृत में 'काव्य' क्या है?",
    options_en: ["Poetry", "Prose", "Drama", "Grammar"],
    options_hi: ["काव्य / कविता", "गद्य", "नाटक", "व्याकरण"],
    answer_en: "Poetry",
    answer_hi: "काव्य / कविता",
    attempted: false,
    selected: ""
  },
  {
    num: 23,
    question_en: "Which is a famous work of Bharavi?",
    question_hi: "भारवि का प्रसिद्ध काव्य कौन सा है?",
    options_en: ["Shishupala Vadha", "Meghaduta", "Raghuvamsha", "Abhijnanasakuntalam"],
    options_hi: ["शिशुपालवध", "मेघदूत", "रघुवंश", "अभिज्ञानशाकुन्तलम्"],
    answer_en: "Shishupala Vadha",
    answer_hi: "शिशुपालवध",
    attempted: false,
    selected: ""
  ...
  {
    num: 24,
    question_en: "Who is called 'Sanskrit scholar and poet'?",
    question_hi: "किसे 'संस्कृत विद्वान और कवि' कहा जाता है?",
    options_en: ["Kalidasa", "Bharavi", "Bhasa", "Bhavabhuti"],
    options_hi: ["कालिदास", "भारवि", "भास", "भावभूति"],
    answer_en: "Kalidasa",
    answer_hi: "कालिदास",
    attempted: false,
    selected: ""
  ...
  {
    num: 25,
    question_en: "What is 'Ukti' in Sanskrit?",
    question_hi: "संस्कृत में 'उक्ति' क्या है?",
    options_en: ["Expression", "Sentence", "Verb", "Compound word"],
    options_hi: ["उक्ति / अभिव्यक्ति", "वाक्य", "क्रिया", "समास"],
    answer_en: "Expression",
    answer_hi: "उक्ति / अभिव्यक्ति",
    attempted: false,
    selected: ""
  },
  {
    num: 26,
    question_en: "Who wrote 'Ratnavali'?",
    question_hi: "'रत्नावली' किसने लिखा?",
    options_en: ["Harsha", "Kalidasa", "Bharavi", "Bhavabhuti"],
    options_hi: ["हर्ष", "कालिदास", "भारवि", "भावभूति"],
    answer_en: "Harsha",
    answer_hi: "हर्ष",
    attempted: false,
    selected: ""
  ...
  {
    num: 27,
    question_en: "Which is known as 'Nataka' in Sanskrit literature?",
    question_hi: "संस्कृत साहित्य में 'नाटक' किसे कहते हैं?",
    options_en: ["Drama", "Poetry", "Essay", "Proverb"],
    options_hi: ["नाटक", "काव्य", "निबंध", "कहावत"],
    answer_en: "Drama",
    answer_hi: "नाटक",
    attempted: false,
    selected: ""
  ...
  {
    num: 28,
    question_en: "What is 'Alankara' in Sanskrit poetry?",
    question_hi: "संस्कृत काव्य में 'अलंकार' क्या है?",
    options_en: ["Figure of speech", "Verb", "Noun", "Sentence"],
    options_hi: ["अलंकार / अलंकारिक", "क्रिया", "संज्ञा", "वाक्य"],
    answer_en: "Figure of speech",
    answer_hi: "अलंकार / अलंकारिक",
    attempted: false,
    selected: ""
  },
  {
    num: 29,
    question_en: "Which poet wrote 'Kumarasambhavam'?",
  ...
  {
    num: 30,
    question_en: "Which work is considered classical Sanskrit drama?",
    question_hi: "कौन सा कार्य शास्त्रीय संस्कृत नाटक माना जाता है?",
    options_en: ["Abhijnanasakuntalam", "Meghaduta", "Raghuvamsha", "Shishupala Vadha"],
    options_hi: ["अभिज्ञानशाकुन्तलम्", "मेघदूत", "रघुवंश", "शिशुपालवध"],
    answer_en: "Abhijnanasakuntalam",
    answer_hi: "अभिज्ञानशाकुन्तलम्",
    attempted: false,
    selected: ""
  },
  {
    num: 31,
    question_en: "Who composed 'Mahabharata'?",
    question_hi: "'महाभारत' किसने रचा?",
    options_en: ["Vyasa", "Valmiki", "Kalidasa", "Bharavi"],
    options_hi: ["व्यास", "वाल्मीकि", "कालिदास", "भारवि"],
    answer_en: "Vyasa",
    answer_hi: "व्यास",
    attempted: false,
    selected: ""
  ...
  {
    num: 32,
    question_en: "Which poet wrote 'Harshacharita'?",
    question_hi: "'हर्षचरित' किसने लिखा?",
    options_en: ["Banabhatta", "Kalidasa", "Bharavi", "Bhavabhuti"],
    options_hi: ["बाणभट्ट", "कालिदास", "भारवि", "भावभूति"],
  ...
  {
    num: 33,
    question_en: "What is 'Prakriti' in Sanskrit grammar?",
    question_hi: "संस्कृत व्याकरण में 'प्रकृति' क्या है?",
    options_en: ["Root form", "Verb", "Noun", "Suffix"],
    options_hi: ["मूल रूप", "क्रिया", "संज्ञा", "प्रत्यय"],
    answer_en: "Root form",
    answer_hi: "मूल रूप",
    attempted: false,
    selected: ""
  ...
  {
    num: 34,
    question_en: "Who is the author of 'Vikramorvashiyam'?",
    question_hi: "'विक्रमोर्वशीयम्' किसने लिखा?",
    options_en: ["Kalidasa", "Bhasa", "Bhavabhuti", "Bharavi"],
    options_hi: ["कालिदास", "भास", "भावभूति", "भारवि"],
    answer_en: "Kalidasa",
    answer_hi: "कालिदास",
  ...
  {
    num: 35,
    question_en: "Which is a famous poetic form in Sanskrit?",
    question_hi: "संस्कृत में प्रसिद्ध काव्य रूप कौन सा है?",
    options_en: ["Shloka", "Prose", "Essay", "Letter"],
    options_hi: ["श्लोक", "गद्य", "निबंध", "पत्र"],
    answer_en: "Shloka",
    answer_hi: "श्लोक",
    attempted: false,
    selected: ""
  ...
  {
    num: 36,
    question_en: "What is 'Vritta' in Sanskrit poetry?",
    question_hi: "संस्कृत काव्य में 'वृत्त' क्या है?",
    options_en: ["Metre / Rhythm", "Verb", "Noun", "Sentence"],
    options_hi: ["छंद / लय", "क्रिया", "संज्ञा", "वाक्य"],
    answer_en: "Metre / Rhythm",
    answer_hi: "छंद / लय",
    attempted: false,
    selected: ""
  },
  {
    num: 37,
    question_en: "Who composed 'Raghuvamsha'?",
    question_hi: "'रघुवंश' किसने रचा?",
    options_en: ["Kalidasa", "Bharavi", "Magha", "Bhavabhuti"],
    options_hi: ["कालिदास", "भारवि", "माघ", "भावभूति"],
    answer_en: "Kalidasa",
    answer_hi: "कालिदास",
  ...
  {
    num: 38,
    question_en: "Which Veda is called the 'Knowledge of melodies'?",
    question_hi: "कौन सा वेद 'संगीत का ज्ञान' कहलाता है?",
    options_en: ["Samaveda", "Rigveda", "Yajurveda", "Atharvaveda"],
    options_hi: ["सामवेद", "ऋग्वेद", "यजुर्वेद", "अथर्ववेद"],
    answer_en: "Samaveda",
    answer_hi: "सामवेद",
    attempted: false,
    selected: ""
  ...
  {
    num: 39,
    question_en: "What is 'Pratyaya' in Sanskrit grammar?",
    question_hi: "संस्कृत व्याकरण में 'प्रत्यय' क्या है?",
    options_en: ["Suffix", "Prefix", "Verb", "Compound word"],
    options_hi: ["प्रत्यय", "उपसर्ग", "क्रिया", "समास"],
    answer_en: "Suffix",
    answer_hi: "प्रत्यय",
    attempted: false,
    selected: ""
  ...
  {
    num: 40,
    question_en: "Who wrote 'Bhavaprakasha'?",
    question_hi: "'भावप्रकाश' किसने लिखा?",
    options_en: ["Bhavabhuti", "Kalidasa", "Bharavi", "Bhasa"],
    options_hi: ["भावभूति", "कालिदास", "भारवि", "भास"],
    answer_en: "Bhavabhuti",
    answer_hi: "भावभूति",
  ...
  {
    num: 41,
    question_en: "What is 'Upasarga' in Sanskrit grammar?",
    question_hi: "संस्कृत व्याकरण में 'उपसर्ग' क्या है?",
    options_en: ["Prefix", "Suffix", "Root word", "Sentence"],
    options_hi: ["उपसर्ग", "प्रत्यय", "मूल शब्द", "वाक्य"],
    answer_en: "Prefix",
    answer_hi: "उपसर्ग",
    attempted: false,
    selected: ""
  ...
  {
    num: 42,
    question_en: "Which poet wrote 'Prabodha Chandrodaya'?",
    question_hi: "'प्रबोधचन्द्रोदय' किसने लिखा?",
    options_en: ["Krishna Mishra", "Kalidasa", "Bharavi", "Bhavabhuti"],
    options_hi: ["कृष्ण मिश्रा", "कालिदास", "भारवि", "भावभूति"],
    answer_en: "Krishna Mishra",
    answer_hi: "कृष्ण मिश्रा",
    attempted: false,
    selected: ""
  },
  {
    num: 43,
    question_en: "Which is considered 'Classical Sanskrit poetry'?",
    question_hi: "कौन सा काव्य शास्त्रीय संस्कृत काव्य माना जाता है?",
    options_en: ["Kumarasambhavam", "Meghaduta", "Raghuvamsha", "Shishupala Vadha"],
    options_hi: ["कुमारसंभव", "मेघदूत", "रघुवंश", "शिशुपालवध"],
    answer_en: "Kumarasambhavam",
    answer_hi: "कुमारसंभव",
    attempted: false,
    selected: ""
  },
  {
    num: 44,
    question_en: "Who is known as 'Kavi Ratna'?",
    question_hi: "'कवि रत्न' के रूप में किसे जाना जाता है?",
    options_en: ["Bharavi", "Kalidasa", "Bhavabhuti", "Bhasa"],
    options_hi: ["भारवि", "कालिदास", "भावभूति", "भास"],
    answer_en: "Bharavi",
    answer_hi: "भारवि",
    attempted: false,
    selected: ""
  ...
  {
    num: 45,
    question_en: "Which work is a Sanskrit epic poem?",
    question_hi: "कौन सा कार्य संस्कृत महाकाव्य है?",
    options_en: ["Raghuvamsha", "Abhijnanasakuntalam", "Mudrarakshasa", "Nagananda"],
    options_hi: ["रघुवंश", "अभिज्ञानशाकुन्तलम्", "मुद्राराक्षस", "नागानन्द"],
    answer_en: "Raghuvamsha",
    answer_hi: "रघुवंश",
    attempted: false,
    selected: ""
  },
  {
    num: 46,
    question_en: "What is 'Vakya' in Sanskrit?",
    question_hi: "संस्कृत में 'वाक्य' क्या है?",
    options_en: ["Sentence", "Word", "Verse", "Poem"],
    options_hi: ["वाक्य", "शब्द", "छंद", "काव्य"],
    answer_en: "Sentence",
    answer_hi: "वाक्य",
    attempted: false,
    selected: ""
  ...
  {
    num: 48,
    question_en: "Which Sanskrit text is about duties and morality?",
    question_hi: "कौन सा संस्कृत ग्रंथ धर्म और कर्तव्यों के बारे में है?",
    options_en: ["Manusmriti", "Bhagavad Gita", "Ramayana", "Mahabharata"],
    options_hi: ["मनुस्मृति", "भगवद गीता", "रामायण", "महाभारत"],
    answer_en: "Manusmriti",
    answer_hi: "मनुस्मृति",
    attempted: false,
    selected: ""
  },
  {
    num: 49,
    question_en: "What is 'Vachya' in Sanskrit grammar?",
    question_hi: "संस्कृत व्याकरण में 'वाच्य' क्या है?",
    options_en: ["Voice of verb", "Tense", "Mood", "Case"],
    options_hi: ["क्रिया का वाच्य", "काल", "वाच्य", "कारक"],
    answer_en: "Voice of verb",
    answer_hi: "क्रिया का वाच्य",
    attempted: false,
    selected: ""
  },
  {
    num: 50,
    question_en: "Who wrote 'Prasthanatrayi' commentaries?",
    question_hi: "'प्रस्थानत्रयी' की टीकाएँ किसने लिखी?",
    options_en: ["Adi Shankaracharya", "Ramanujacharya", "Madhvacharya", "Vyasa"],
    options_hi: ["आदि शंकराचार्य", "रामानुजाचार्य", "माध्वाचार्य", "व्यास"],
    answer_en: "Adi Shankaracharya",
    answer_hi: "आदि शंकराचार्य",
    attempted: false,
    selected: ""
  }
];
