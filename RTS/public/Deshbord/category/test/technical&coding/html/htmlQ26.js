const questions = [
  {
    ...
    "question_hi": "फॉर्म को परिभाषित करने के लिए कौन सा HTML टैग उपयोग होता है?",
  ...
  {
    "num": 2,
    "question_en": "Which HTML tag is used to define an input field?",
    "question_hi": "इनपुट फील्ड को परिभाषित करने के लिए कौन सा HTML टैग उपयोग होता है?",
    "options_en": ["input", "text", "field", "textbox"],
    "options_hi": ["input", "text", "field", "textbox"],
    "answer_en": "input",
    "answer_hi": "input",
    "attempted": false,
    "selected": ""
  },
  {
    ...
    "options_en": ["textarea", "text", "input", "multiline"],
    "options_hi": ["textarea", "text", "input", "multiline"],
    "answer_en": "textarea",
    "answer_hi": "textarea",
    "attempted": false,
    "selected": ""
  ...
  {
    "num": 6,
    "question_en": "Which HTML tag is used to define an option in dropdown?",
  ...
  {
    "num": 7,
    "question_en": "Which HTML tag is used to define a label?",
    "question_hi": "लेबल को परिभाषित करने के लिए कौन सा HTML टैग उपयोग होता है?",
  ...
  {
    "num": 9,
    "question_en": "Which HTML tag is used to define a legend?",
    "question_hi": "लेजेंड को परिभाषित करने के लिए कौन सा HTML टैग उपयोग होता है?",
  ...
  {
    "num": 18,
    "question_en": "Which HTML tag is used to define a command?",
    "question_hi": "कमांड को परिभाषित करने के लिए कौन सा HTML टैग उपयोग होता है?",
  ...
  {
    "num": 20,
    "question_en": "Which HTML tag is used to define a datagrid?",
    "question_hi": "डेटाग्रिड को परिभाषित करने के लिए कौन सा HTML टैग उपयोग होता है?",
    "options_en": ["datagrid", "grid", "table", "data"],
    "options_hi": ["datagrid", "grid", "table", "data"],
    "answer_en": "datagrid",
    "answer_hi": "datagrid",
    "attempted": false,
    "selected": ""
  ...
  {
    "num": 32,
    "question_en": "Which HTML tag is used to define a mark element?",
    "question_hi": "मार्क एलिमेंट को परिभाषित करने के लिए कौन सा HTML टैग उपयोग होता है?",
  ...
  {
    "num": 36,
    "question_en": "Which HTML tag is used to define a bdi element?",
    "question_hi": "BDI एलिमेंट को परिभाषित करने के लिए कौन सा HTML टैग उपयोग होता है?",
  ...
  {
    "num": 37,
    "question_en": "Which HTML tag is used to define a bdo element?",
    "question_hi": "BDO एलिमेंट को परिभाषित करने के लिए कौन सा HTML टैग उपयोग होता है?",
  ...
  {
    "num": 38,
    "question_en": "Which HTML tag is used to define a wbr element?",
    "question_hi": "WBR एलिमेंट को परिभाषित करने के लिए कौन सा HTML टैग उपयोग होता है?",
