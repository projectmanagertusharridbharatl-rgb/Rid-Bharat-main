const questions = [
  {
    num: 1,
    question_en:
      "Which property specifies the width of the space between table cells?",
    question_hi:
      "टेबल सेल्स के बीच की जगह की चौड़ाई कौन सी प्रॉपर्टी सेट करती है?",
    options_en: ["border-spacing", "padding", "margin", "border-width"],
    options_hi: [
      "सेलों के बीच जगह (border-spacing)",
      "पैडिंग (padding)",
      "मार्जिन (margin)",
      "बॉर्डर की मोटाई (border-width)",
    ],
  ...
  },
  {
    ...
    question_hi:
      "टेबल सेल के अंदर जगह बढ़ाने के लिए कौन सी प्रॉपर्टी उपयोग होती है?",
    options_en: ["padding", "margin", "border-spacing", "border-collapse"],
    options_hi: [
      "पैडिंग (padding)",
      "मार्जिन (margin)",
      "सेलों के बीच जगह (border-spacing)",
      "बॉर्डर-कॉलैप्स (border-collapse)",
    ],
    answer_en: "padding",
  ...
  },
  {
    num: 4,
    question_en:
      "Which property controls the border thickness of a table cell?",
    question_hi:
      "टेबल सेल की बॉर्डर की मोटाई को कौन सी प्रॉपर्टी नियंत्रित करती है?",
  ...
  },
  {
    num: 5,
    question_en:
      "Which property specifies the space outside the border of a table cell?",
    question_hi:
      "टेबल सेल के बॉर्डर के बाहर की जगह कौन सी प्रॉपर्टी सेट करती है?",
  ...
  },
  {
    num: 6,
    question_en:
      "Which property specifies whether table borders are visible or hidden?",
  ...
  },
  {
    num: 7,
    question_en:
      "Which value of border-collapse collapses the borders into a single border?",
    question_hi:
      "border-collapse की कौन सी वैल्यू बॉर्डर्स को एकल बॉर्डर में बदलती है?",
  ...
  },
  {
    num: 8,
    question_en:
      "Which property defines the color of the border of a table cell?",
  ...
  },
  {
    num: 9,
    question_en:
      "Which CSS property sets the background color inside table cells?",
    question_hi:
      "टेबल सेल के अंदर बैकग्राउंड रंग सेट करने वाली CSS प्रॉपर्टी कौन सी है?",
  ...
  },
  {
    ...
    question_hi:
      "टेबल के बॉर्डर के लेआउट को नियंत्रित करने वाली प्रॉपर्टी कौन सी है?",
    options_en: ["border-collapse", "border-spacing", "padding", "margin"],
    options_hi: [
      "बॉर्डर-कॉलैप्स (border-collapse)",
      "सेलों के बीच जगह (border-spacing)",
  ...
  },
  {
    num: 11,
    question_en:
      "Which property sets the horizontal alignment of text in table cells?",
    question_hi:
      "टेबल सेल्स में टेक्स्ट की क्षैतिज संरेखण सेट करने वाली प्रॉपर्टी कौन सी है?",
    options_en: ["text-align", "vertical-align", "padding", "margin"],
    options_hi: [
      "टेक्स्ट-अलाइन (text-align)",
      "वर्टिकल-अलाइन (vertical-align)",
      "पैडिंग (padding)",
      "मार्जिन (margin)",
    ],
  ...
  },
  {
    num: 12,
    question_en:
      "Which property sets the vertical alignment of content in table cells?",
    question_hi:
      "टेबल सेल्स में कंटेंट की ऊर्ध्वाधर संरेखण सेट करने वाली प्रॉपर्टी कौन सी है?",
  ...
  },
  {
    num: 13,
    question_en:
      "Which property specifies the style of the border (solid, dashed, dotted) for table cells?",
    question_hi:
      "टेबल सेल्स के लिए बॉर्डर का स्टाइल (सॉलिड, डैश्ड, डॉटेड) कौन सी प्रॉपर्टी सेट करती है?",
    options_en: [
      "border-style",
      "border-width",
      "border-color",
  ...
  },
  {
    num: 14,
    question_en:
      "Which property specifies if the table layout algorithm is fixed or automatic?",
    question_hi:
      "टेबल लेआउट एल्गोरिद्म फिक्स्ड या ऑटोमेटिक होने को कौन सी प्रॉपर्टी सेट करती है?",
    options_en: [
      "table-layout",
      "border-collapse",
      "border-spacing",
  ...
  },
  {
    num: 15,
    question_en:
      "Which value of table-layout makes the table width depend on the content?",
    question_hi:
      "table-layout की कौन सी वैल्यू टेबल की चौड़ाई को कंटेंट पर निर्भर बनाती है?",
  ...
  },
  {
    ...
    options_hi: [
      "कैप्शन-साइड (caption-side)",
      "कैप्शन-अलाइन (caption-align)",
      "टेक्स्ट-अलाइन (text-align)",
      "वर्टिकल-अलाइन (vertical-align)",
    ],
  ...
  },
  {
    num: 19,
    question_en:
      "Which property controls whether table cells wrap content or overflow?",
    question_hi:
      "टेबल सेल्स में कंटेंट रैप हो या ओवरफ्लो हो इसे नियंत्रित करने वाली प्रॉपर्टी कौन सी है?",
    options_en: ["white-space", "overflow", "text-wrap", "text-overflow"],
    options_hi: [
      "व्हाइट-स्पेस (white-space)",
      "ओवरफ्लो (overflow)",
      "टेक्स्ट-रैप (text-wrap)",
      "टेक्स्ट-ओवरफ्लो (text-overflow)",
    ],
  ...
  },
  {
    num: 20,
    question_en:
      "Which property is used to add a border around the entire table?",
    question_hi:
      "पूरे टेबल के चारों ओर बॉर्डर जोड़ने के लिए कौन सी प्रॉपर्टी उपयोग होती है?",
  ...
  },
  {
    ...
    question_hi:
      "टेबल कॉलम की न्यूनतम चौड़ाई सेट करने वाली प्रॉपर्टी कौन सी है?",
    options_en: ["min-width", "max-width", "width", "table-layout"],
    options_hi: [
      "मिन-चौड़ाई (min-width)",
      "मैक्स-चौड़ाई (max-width)",
      "चौड़ाई (width)",
      "टेबल-लेआउट (table-layout)",
    ],
    answer_en: "min-width",
  ...
  },
  {
    num: 22,
    question_en:
      "Which property controls spacing inside cells in a collapsed border table?",
    question_hi:
      "कॉलैप्स्ड बॉर्डर टेबल में सेल के अंदर की जगह को नियंत्रित करने वाली प्रॉपर्टी कौन सी है?",
  ...
  },
  {
    num: 23,
    question_en:
      "Which CSS property makes the table responsive by setting width to 100%?",
    question_hi:
      "टेबल को रेस्पॉन्सिव बनाने के लिए कौन सी CSS प्रॉपर्टी की चौड़ाई 100% सेट करती है?",
  ...
  },
  {
    num: 24,
    question_en:
      "Which property sets the space between the border and the content of a table cell?",
    question_hi:
      "टेबल सेल के कंटेंट और बॉर्डर के बीच की जगह कौन सी प्रॉपर्टी सेट करती है?",
  ...
  },
  {
    num: 25,
    question_en:
      "Which property sets the table’s border color and style together?",
    question_hi:
      "टेबल के बॉर्डर का रंग और स्टाइल एक साथ सेट करने वाली प्रॉपर्टी कौन सी है?",
    options_en: ["border", "border-width", "border-style", "border-color"],
    options_hi: [
      "बॉर्डर (border)",
      "बॉर्डर की मोटाई (border-width)",
  ...
  },
  {
    ...
    question_hi:
      "टेबल की पंक्तियों के बीच की जगह को कौन सी प्रॉपर्टी नियंत्रित करती है?",
  ...
  },
  {
    num: 27,
    question_en:
      "Which CSS property allows you to specify whether table cells have fixed or dynamic widths?",
    question_hi:
      "कौन सी CSS प्रॉपर्टी टेबल सेल्स की चौड़ाई को फिक्स्ड या डायनेमिक बनाने की अनुमति देती है?",
  ...
  },
  {
    num: 29,
    question_en:
      "Which property can be used to control the overflow of text in table cells?",
    question_hi:
      "टेबल सेल्स में टेक्स्ट के ओवरफ्लो को नियंत्रित करने के लिए कौन सी प्रॉपर्टी उपयोग होती है?",
  ...
  },
  {
    num: 30,
    question_en:
      "Which CSS property is used to add space between table columns?",
    question_hi:
      "टेबल कॉलम के बीच जगह बढ़ाने के लिए कौन सी CSS प्रॉपर्टी इस्तेमाल होती है?",
  ...
  },
  {
    num: 33,
    question_en:
      "Which property is used to control the spacing between rows in a table?",
    question_hi:
      "टेबल की पंक्तियों के बीच की जगह को नियंत्रित करने वाली प्रॉपर्टी कौन सी है?",
    options_en: ["border-spacing", "border-collapse", "padding", "margin"],
    options_hi: [
      "सेलों के बीच जगह (border-spacing)",
      "बॉर्डर-कॉलैप्स (border-collapse)",
  ...
  },
  {
    num: 35,
    question_en:
      "Which property can be used to add borders to individual table cells?",
    question_hi:
      "टेबल की व्यक्तिगत सेल्स को बॉर्डर देने के लिए कौन सी प्रॉपर्टी इस्तेमाल होती है?",
  ...
  },
  {
    num: 36,
    question_en:
      "Which property allows you to set the maximum width of a table?",
  ...
  },
  {
    num: 38,
    question_en:
      "Which property controls the space between the content and the border inside table cells?",
    question_hi:
      "टेबल सेल के अंदर कंटेंट और बॉर्डर के बीच की जगह को कौन सी प्रॉपर्टी नियंत्रित करती है?",
    options_en: ["padding", "margin", "border-spacing", "border-width"],
    options_hi: [
      "पैडिंग (padding)",
      "मार्जिन (margin)",
  ...
  },
  {
    num: 40,
    question_en:
      "Which property sets the border radius of table cells to create rounded corners?",
    question_hi:
      "टेबल सेल्स के कोनों को गोल बनाने के लिए कौन सी प्रॉपर्टी उपयोग होती है?",
    options_en: [
      "border-radius",
      "border-width",
      "border-style",
  ...
  },
  {
    ...
    question_hi:
      "टेबल सेल्स के अंदर फॉन्ट स्टाइल को नियंत्रित करने वाली प्रॉपर्टी कौन सी है?",
  ...
  },
  {
    ...
    question_hi:
      "टेबल सेल्स के अंदर फॉन्ट वेट सेट करने वाली प्रॉपर्टी कौन सी है?",
  ...
  },
  {
    num: 43,
    question_en:
      "Which property sets the font family for text inside table cells?",
    question_hi:
      "टेबल सेल्स के अंदर टेक्स्ट के लिए फॉन्ट फैमिली सेट करने वाली प्रॉपर्टी कौन सी है?",
  ...
  },
  {
    ...
    question_hi:
      "टेबल सेल्स के अंदर टेक्स्ट का रंग सेट करने वाली प्रॉपर्टी कौन सी है?",
  ...
  },
  {
    ...
    question_hi:
      "टेबल बॉर्डर की दृश्यता को नियंत्रित करने वाली प्रॉपर्टी कौन सी है?",
    options_en: [
      "border-style",
      "border-width",
      "border-color",
  ...
  },
  {
    num: 46,
    question_en:
      "Which property can be used to hide table borders without removing the border style?",
    question_hi:
      "बॉर्डर स्टाइल हटाए बिना टेबल बॉर्डर को छुपाने के लिए कौन सी प्रॉपर्टी इस्तेमाल होती है?",
    options_en: [
  ...
  },
  {
    num: 47,
    question_en:
      "Which property can be used to add a background color to an entire table?",
    question_hi:
      "पूरे टेबल के लिए बैकग्राउंड रंग जोड़ने वाली प्रॉपर्टी कौन सी है?",
  ...
  },
  {
    num: 48,
    question_en:
      "Which property defines how table content is aligned horizontally by default?",
  ...
  },
  {
    num: 49,
    question_en:
      "Which CSS property can be used to set spacing between the borders of adjacent table cells?",
    question_hi:
      "निकटवर्ती टेबल सेल्स के बॉर्डर्स के बीच जगह सेट करने वाली CSS प्रॉपर्टी कौन सी है?",
    options_en: ["border-spacing", "padding", "margin", "border-collapse"],
    options_hi: [
      "सेलों के बीच जगह (border-spacing)",
      "पैडिंग (padding)",
  ...
  },
  {
    num: 50,
    question_en:
      "Which property is used to set the width of table columns individually?",
    question_hi:
      "टेबल कॉलम की चौड़ाई व्यक्तिगत रूप से सेट करने वाली प्रॉपर्टी कौन सी है?",
