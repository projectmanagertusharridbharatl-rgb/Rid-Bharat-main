const questions = [
  ...
  },
  {
    ...
    question_hi:
      "CSS specificity में ID सेलेक्टर को कौन सा weight दिया जाता है?",
  ...
  },
  {
    num: 4,
    question_en:
      "In CSS specificity, what weight is given to a class selector?",
    question_hi:
      "CSS specificity में क्लास सेलेक्टर को कौन सा weight दिया जाता है?",
  ...
  },
  {
    num: 5,
    question_en:
      "In CSS specificity, what weight is given to an element selector?",
    question_hi:
      "CSS specificity में एलिमेंट सेलेक्टर को कौन सा weight दिया जाता है?",
  ...
  },
  {
    num: 6,
    question_en:
      "Which CSS rule will override the others if all target the same element?",
    question_hi:
      "यदि सभी नियम एक ही एलिमेंट को टारगेट करते हैं तो कौन सा CSS नियम ओवरराइड करेगा?",
    options_en: [
  ...
  },
  {
    num: 8,
    question_en:
      "If two selectors have the same specificity, which one is applied?",
    question_hi:
      "यदि दो सेलेक्टर्स की specificity समान हो, तो कौन सा लागू होगा?",
    options_en: [
  ...
  },
  {
    ...
    options_en: ["color", "margin", "border", "padding"],
    options_hi: [
      "रंग (color)",
      "मार्जिन (margin)",
      "बॉर्डर (border)",
  ...
  },
  {
    ...
    options_en: ["margin", "color", "font-family", "visibility"],
    options_hi: [
      "मार्जिन (margin)",
      "रंग (color)",
  ...
  },
  {
    ...
    question_hi:
      "किस कीवर्ड का उपयोग किसी प्रॉपर्टी के इनहेरिट होने के लिए किया जाता है?",
    options_en: ["inherit", "initial", "unset", "revert"],
    options_hi: ["inherit", "initial", "unset", "revert"],
    answer_en: "inherit",
    answer_hi: "inherit",
    attempted: false,
    selected: "",
  ...
  },
  {
    ...
    options_en: ["element", ".class", "#id", "inline style"],
    options_hi: ["एलिमेंट", ".क्लास", "#ID", "इनलाइन स्टाइल"],
    answer_en: "inline style",
    answer_hi: "इनलाइन स्टाइल",
    attempted: false,
    selected: "",
  },
  {
    ...
    options_en: ["No", "Yes", "Only sometimes", "Depends on browser"],
  ...
  },
  {
    num: 16,
    question_en:
      "Which CSS rule wins if two selectors have same specificity and importance?",
    question_hi:
      "यदि दो सेलेक्टर्स की specificity और importance समान हो, तो कौन सा CSS नियम जीतता है?",
    options_en: [
      "The one declared last",
      "The one declared first",
      "The one with ID selector",
  ...
  },
  {
    ...
    question_hi:
      "कौन सी CSS प्रॉपर्टी इनहेरिटेंस व्यवहार को नियंत्रित करती है?",
    options_en: ["inherit", "initial", "unset", "none"],
    options_hi: ["inherit", "initial", "unset", "none"],
    answer_en: "inherit",
    answer_hi: "inherit",
    attempted: false,
    selected: "",
  },
  {
    ...
    options_en: ["No", "Yes", "Only in some browsers", "Depends on property"],
    options_hi: [
      "नहीं",
      "हाँ",
      "कुछ ब्राउज़र में",
  ...
  },
  {
    ...
    options_en: ["Yes", "No", "Depends on browser", "Only for some elements"],
    options_hi: [
      "हाँ",
      "नहीं",
  ...
  },
  {
    num: 20,
    question_en:
      "Which of the following selectors does NOT contribute to specificity?",
    question_hi:
      "निम्नलिखित में से कौन सा सेलेक्टर specificity में योगदान नहीं देता?",
    options_en: [
      "Universal selector (*)",
      "ID selector",
      "Class selector",
  ...
  },
  {
    num: 22,
    question_en:
      "Which CSS property can inherit values from its parent element?",
    question_hi:
      "कौन सी CSS प्रॉपर्टी पैरेंट एलिमेंट से वैल्यू इनहेरिट कर सकती है?",
    options_en: ["color", "margin", "border", "padding"],
    options_hi: [
      "रंग (color)",
      "मार्जिन (margin)",
  ...
  },
  {
    num: 23,
    question_en:
      "Which CSS value forces a property to revert to its inherited value?",
    question_hi:
      "कौन सा CSS मान प्रॉपर्टी को उसके इनहेरिटेड मान पर वापस लाता है?",
    options_en: ["inherit", "initial", "unset", "revert"],
    options_hi: ["inherit", "initial", "unset", "revert"],
    answer_en: "inherit",
    answer_hi: "inherit",
  ...
  },
  {
    ...
    question_hi:
      "निम्नलिखित में से कौन CSS specificity को सबसे अधिक बढ़ाता है?",
    options_en: [
  ...
  },
  {
    num: 26,
    question_en:
      "What is the specificity of an attribute selector like [type='text']?",
    question_hi:
      "एक एट्रिब्यूट सेलेक्टर जैसे [type='text'] की specificity क्या है?",
    options_en: ["10", "100", "1", "0"],
    options_hi: ["10", "100", "1", "0"],
    answer_en: "10",
    answer_hi: "10",
  ...
  },
  {
    num: 30,
    question_en:
      "If a child element has 'color: inherit;', where does it get the color from?",
    question_hi:
      "यदि चाइल्ड एलिमेंट में 'color: inherit;' है, तो वह रंग कहाँ से लेता है?",
    options_en: [
    ...
    options_hi: [
      "अपने पैरेंट एलिमेंट से",
      "ब्राउज़र डिफ़ॉल्ट से",
      "खुद से",
      "सिब्लिंग एलिमेंट्स से",
    ],
  ...
  },
  {
    ...
    question_hi:
      "क्या pseudo-elements जैसे ::before specificity को प्रभावित करते हैं?",
  ...
  },
  {
    num: 34,
    question_en:
      "If two CSS selectors have the same specificity, which rule applies?",
    question_hi:
      "यदि दो CSS सेलेक्टर्स की specificity समान हो, तो कौन सा नियम लागू होगा?",
    options_en: [
      "The one declared last",
      "The one declared first",
  ...
  },
  {
    num: 35,
    question_en:
      "Which of these CSS values removes inheritance and resets to initial?",
    question_hi:
      "इनमें से कौन सा CSS मान इनहेरिटेंस हटाकर प्रॉपर्टी को इनिशियल पर सेट करता है?",
  ...
  },
  {
    ...
    question_hi:
      "क्या CSS नियमों का क्रम यह प्रभावित करता है कि कौन सा स्टाइल लागू होगा?",
    options_en: ["Yes", "No", "Only for inline styles", "Depends on browser"],
    options_hi: [
      "हाँ",
      "नहीं",
      "केवल इनलाइन स्टाइल्स के लिए",
      "ब्राउज़र पर निर्भर करता है",
    ],
    answer_en: "Yes",
    answer_hi: "हाँ",
  ...
  },
  {
    ...
    question_hi:
      "कौन सा CSS सेलेक्टर अपने पैरेंट के पहले बच्चे को टारगेट करता है?",
  ...
  },
  {
    num: 42,
    question_en:
      "Which CSS selector targets elements that are the only child of their parent?",
    question_hi:
      "कौन सा CSS सेलेक्टर उन एलिमेंट्स को टारगेट करता है जो अपने पैरेंट के केवल बच्चे हैं?",
  ...
  },
  {
    ...
    question_hi:
      "'checked' एट्रिब्यूट वाले एलिमेंट्स पर स्टाइल लागू करने वाला pseudo-class कौन सा है?",
  ...
  },
  {
    ...
    question_hi:
      "अक्षम फॉर्म एलिमेंट्स पर स्टाइल लागू करने वाला pseudo-class कौन सा है?",
  ...
  },
  {
    ...
    question_hi:
      "कौन सा सेलेक्टर वर्तमान में फोकस किए गए एलिमेंट्स पर स्टाइल लागू करता है?",
  ...
  },
  {
    num: 49,
    question_en:
      "What is the CSS property to control whether children inherit a property?",
    question_hi:
      "कौन सी CSS प्रॉपर्टी बच्चों को किसी प्रॉपर्टी के इनहेरिट करने को नियंत्रित करती है?",
    options_en: ["inherit", "initial", "unset", "all"],
    options_hi: ["inherit", "initial", "unset", "all"],
    answer_en: "inherit",
    answer_hi: "inherit",
