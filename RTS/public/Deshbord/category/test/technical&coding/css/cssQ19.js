const questions = [
  ...
  },
  {
    ...
    question_hi:
      "यदि बॉर्डर चौड़ाई निर्दिष्ट न हो तो डिफ़ॉल्ट चौड़ाई क्या होती है?",
  ...
  },
  {
    ...
    question_hi:
      "बॉर्डर रंग सेट करने के लिए कौन सी प्रॉपर्टी उपयोग की जाती है?",
    options_en: [
      "border-color",
      "border-style",
      "border-width",
  ...
  },
  {
    num: 6,
    question_en:
      "Which of the following is a key difference between border and outline?",
  ...
  },
  {
    num: 7,
    question_en:
      "Which property controls the space between the outline and the element's edge?",
    question_hi:
      "कौन सी प्रॉपर्टी आउटलाइऩ और एलिमेंट की किनारे के बीच दूरी नियंत्रित करती है?",
  ...
  },
  {
    ...
    question_hi:
      "आउटलाइऩ के स्टाइल को सेट करने के लिए कौन सी प्रॉपर्टी उपयोग होती है?",
    options_en: [
      "outline-style",
      "border-style",
      "outline-width",
  ...
  },
  {
    num: 15,
    question_en:
      "Which CSS shorthand property sets width, style, and color of border?",
    question_hi:
      "कौन सी CSS शॉर्थैंड प्रॉपर्टी बॉर्डर की चौड़ाई, स्टाइल और रंग सेट करती है?",
  ...
  },
  {
    num: 16,
    question_en:
      "How do you set different border styles for each side of an element?",
    question_hi:
      "एलिमेंट के प्रत्येक पक्ष के लिए अलग-अलग बॉर्डर स्टाइल कैसे सेट करें?",
    options_en: [
  ...
  },
  {
    num: 18,
    question_en:
      "Which of these properties does NOT affect the space an element occupies?",
    question_hi:
      "इनमें से कौन सी प्रॉपर्टी एलिमेंट द्वारा घिरी गई जगह को प्रभावित नहीं करती?",
  ...
  },
  {
    ...
    options_hi: [
      ...
      "बॉर्डर: सॉलिड रेड 5px;",
      "बॉर्डर: रेड सॉलिड 5px;",
      "बॉर्डर: 5px रेड सॉलिड;",
    ],
  ...
  },
  {
    ...
    question_hi:
      "क्या आउटलाइऩ एक्सेसिबिलिटी फोकस इंडिकेटर के लिए उपयोग किया जा सकता है?",
    options_en: [
      "Yes",
      "No",
    ...
    options_hi: [
      "हाँ",
      "नहीं",
      "सिर्फ जावास्क्रिप्ट से",
      "सिर्फ CSS वेरिएबल्स से",
    ],
    answer_en: "Yes",
    answer_hi: "हाँ",
    attempted: false,
  ...
  },
  {
    ...
    question_hi:
      "border-style का कौन सा मान दो सॉलिड लाइनों वाला बॉर्डर बनाता है?",
  ...
  },
  {
    ...
    question_hi:
      "यदि आप border-color सेट करते हैं लेकिन border-style नहीं करते तो क्या होगा?",
    options_en: [
  ...
  },
  {
    num: 25,
    question_en:
      "How is the outline different from a border in terms of layout?",
  ...
  },
  {
    num: 26,
    question_en:
      "Which property is used to set a border only at the top of an element?",
    question_hi:
      "कौन सी प्रॉपर्टी का उपयोग केवल एलिमेंट के टॉप बॉर्डर के लिए किया जाता है?",
  ...
  },
  {
    num: 27,
    question_en:
      "How do you make an element’s border invisible but still take space?",
    question_hi:
      "किस प्रकार एक एलिमेंट का बॉर्डर अदृश्य बनाएं लेकिन वह जगह घेरता रहे?",
    options_en: [
  ...
  },
  {
    ...
    question_hi:
      "कौन सी शॉर्थैंड प्रॉपर्टी चारों बॉर्डर साइड्स को अलग-अलग सेट करती है?",
  ...
  },
  {
    num: 32,
    question_en:
      "Which property controls the space between the border and the cell content in tables?",
    question_hi:
      "टेबल में बॉर्डर और सेल कंटेंट के बीच की जगह कौन सी प्रॉपर्टी नियंत्रित करती है?",
  ...
  },
  {
    ...
    question_hi:
      "क्या आउटलाइऩ को बॉर्डर से अलग तरीके से स्टाइल किया जा सकता है?",
    options_en: ["Yes", "No", "Only in some browsers", "Only with JavaScript"],
    options_hi: [
      "हाँ",
      "नहीं",
      "सिर्फ कुछ ब्राउज़रों में",
      "सिर्फ जावास्क्रिप्ट से",
    ],
    answer_en: "Yes",
    answer_hi: "हाँ",
  ...
  },
  {
    num: 34,
    question_en:
      "Which CSS property specifies the style of all four borders at once?",
    question_hi:
      "कौन सी CSS प्रॉपर्टी एक साथ चारों बॉर्डर का स्टाइल सेट करती है?",
  ...
  },
  {
    ...
    question_hi:
      "निम्नलिखित में से कौन सी प्रॉपर्टी बॉर्डर शॉर्थैंड प्रॉपर्टी का हिस्सा नहीं है?",
    options_en: [
      "border-radius",
      "border-width",
      "border-style",
  ...
  },
  {
    ...
    options_hi: [
      "बॉर्डर-लेफ्ट-स्टाइल: डॉटेड;",
      "बॉर्डर-स्टाइल: डॉटेड लेफ्ट;",
      "बॉर्डर-लेफ्ट: डॉटेड;",
      "बॉर्डर-स्टाइल-लेफ्ट: डॉटेड;",
    ],
  ...
  },
  {
    num: 40,
    question_en:
      "Which property can be used to add space between the border and content inside a box?",
    question_hi:
      "कौन सी प्रॉपर्टी बॉर्डर और बॉक्स के अंदर कंटेंट के बीच जगह जोड़ने के लिए इस्तेमाल होती है?",
  ...
  },
  {
    ...
    options_en: [
      ...
      "border-style-bottom: thick;",
    ],
    options_hi: [
      "बॉर्डर-बॉटम-विथ: थिक;",
      "बॉर्डर-विथ-बॉटम: थिक;",
      "बॉर्डर-बॉटम-स्टाइल: थिक;",
      "बॉर्डर-स्टाइल-बॉटम: थिक;",
    ],
  ...
  },
  {
    num: 45,
    question_en:
      "Which property controls the thickness of all four borders individually?",
    question_hi:
      "कौन सी प्रॉपर्टी चारों बॉर्डर की मोटाई अलग-अलग नियंत्रित करती है?",
    options_en: ["border-width", "border-style", "border-color", "border"],
    options_hi: ["बॉर्डर-विथ", "बॉर्डर-स्टाइल", "बॉर्डर-कलर", "बॉर्डर"],
    answer_en: "border-width",
    answer_hi: "बॉर्डर-विथ",
  ...
  },
  {
    num: 46,
    question_en:
      "Which CSS property is used to create space between adjacent table cells?",
    question_hi:
      "टेबल की सटती हुई सेल्स के बीच जगह बनाने के लिए कौन सी CSS प्रॉपर्टी है?",
  ...
  },
  {
    num: 47,
    question_en:
      "What effect does the 'outline' property have on the box model?",
  ...
  },
  {
    num: 48,
    question_en:
      "Which property sets the space between the outline and the edge of the element?",
    question_hi:
      "कौन सी प्रॉपर्टी आउटलाइऩ और एलिमेंट की किनारे के बीच जगह सेट करती है?",
  ...
  },
  {
    ...
    options_hi: [
      ...
      "हाँ",
      "सिर्फ कुछ ब्राउज़रों में",
      "बॉक्स-साइजिंग पर निर्भर करता है",
    ],
    answer_en: "No",
    answer_hi: "नहीं",
    attempted: false,
  ...
  },
  {
    num: 50,
    question_en:
      "Which property would you use to remove the outline when a button is clicked?",
    question_hi:
      "जब बटन क्लिक किया जाए तो आउटलाइऩ हटाने के लिए कौन सी प्रॉपर्टी इस्तेमाल करें?",
    options_en: [
      "outline: none;",
      "border: none;",
      "outline-style: none;",
