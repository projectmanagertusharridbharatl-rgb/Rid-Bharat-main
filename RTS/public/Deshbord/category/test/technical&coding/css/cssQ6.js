const questions = [
  {
    num: 1,
    question_en:
      "Which property controls the alignment of grid items along the row axis?",
    question_hi:
      "कौन-सी प्रॉपर्टी ग्रिड आइटम्स को पंक्ति अक्ष के साथ संरेखित करती है?",
    options_en: [
      "justify-items",
      "align-items",
      "justify-content",
  ...
  },
  {
    num: 2,
    question_en:
      "Which CSS property defines the number of columns in a grid container?",
    question_hi:
      "कौन-सी CSS प्रॉपर्टी ग्रिड कंटेनर में कॉलम की संख्या निर्धारित करती है?",
    options_en: [
  ...
  },
  {
    ...
    question_hi:
      "कौन-सी प्रॉपर्टी ग्रिड पंक्तियों के बीच की दूरी नियंत्रित करती है?",
    options_en: [
      "grid-row-gap",
      "grid-column-gap",
      "grid-gap",
  ...
  },
  {
    num: 4,
    question_en:
      "Which property is shorthand for setting both row and column gaps in grid?",
    question_hi:
      "कौन-सी प्रॉपर्टी ग्रिड में पंक्ति और कॉलम गैप दोनों सेट करने के लिए शॉर्टहैंड है?",
  ...
  },
  {
    num: 6,
    question_en:
      "Which property defines the starting grid line for a grid item?",
    question_hi:
      "कौन-सी प्रॉपर्टी ग्रिड आइटम के लिए शुरूआती ग्रिड लाइन को परिभाषित करती है?",
    options_en: [
      "grid-column-start",
      "grid-row-start",
      "grid-area",
  ...
  },
  {
    ...
    question_hi:
      "कौन-सी प्रॉपर्टी आपको ग्रिड क्षेत्र को नाम देने की अनुमति देती है?",
    options_en: [
      "grid-area",
      "grid-template-areas",
      "grid-template-columns",
  ...
  },
  {
    ...
    question_hi:
      "कौन-सी प्रॉपर्टी ग्रिड-टेम्प्लेट-एरियास को निर्दिष्ट करती है?",
    options_en: [
      "grid-template-areas",
      "grid-area",
      "grid-template-columns",
  ...
  },
  {
    ...
    options_hi: [
      "उपलब्ध स्थान का हिस्सा",
      "पिक्सेल में निश्चित आकार",
      "लचीली पंक्तियाँ",
      "फ़ॉन्ट-सम्बंधित आकार",
    ],
  ...
  },
  {
    num: 13,
    question_en:
      "Which property controls the alignment of grid items along the column axis?",
    question_hi:
      "कौन-सी प्रॉपर्टी ग्रिड आइटम्स को कॉलम अक्ष के साथ संरेखित करती है?",
    options_en: [
      "align-items",
      "justify-items",
      "align-content",
  ...
  },
  {
    ...
    question_hi:
      "कौन-सी प्रॉपर्टी ग्रिड आइटम के लिए अंत ग्रिड लाइन को परिभाषित करती है?",
    options_en: [
      "grid-column-end",
      "grid-row-end",
      "grid-area",
  ...
  },
  {
    ...
    question_hi:
      "कौन-सी CSS प्रॉपर्टी अप्रत्यक्ष ग्रिड पंक्तियों का आकार निर्दिष्ट करती है?",
    options_en: [
      "grid-auto-rows",
      "grid-template-rows",
      "grid-auto-columns",
  ...
  },
  {
    num: 18,
    question_en:
      "Which property controls how content is aligned inside grid cells vertically?",
    question_hi:
      "ग्रिड सेल्स के अंदर सामग्री को लंबवत रूप से कैसे संरेखित किया जाता है यह कौन-सी प्रॉपर्टी नियंत्रित करती है?",
    options_en: [
      "align-content",
      "justify-content",
      "align-items",
  ...
  },
  {
    num: 19,
    question_en:
      "What value of 'grid-auto-flow' places items densely to fill gaps?",
    question_hi:
      "'grid-auto-flow' का कौन-सा मान आइटम्स को अंतराल भरने के लिए घनीभूत (dense) करता है?",
  ...
  },
  {
    ...
    question_hi:
      "कौन-सी प्रॉपर्टी शॉर्टहैंड में ग्रिड आइटम का क्षेत्र निर्दिष्ट करती है?",
  ...
  },
  {
    ...
    question_hi:
      "कौन-सी प्रॉपर्टी ग्रिड आइटम्स के ओवरलैपिंग की अनुमति देती है?",
  ...
  },
  {
    num: 24,
    question_en:
      "Which unit is commonly used to define flexible lengths in CSS Grid?",
    question_hi:
      "CSS Grid में लचीली लंबाई को परिभाषित करने के लिए कौन-सी यूनिट आमतौर पर उपयोग की जाती है?",
    options_en: ["fr", "px", "%", "em"],
    options_hi: ["fr", "px", "%", "em"],
    answer_en: "fr",
    answer_hi: "fr",
  ...
  },
  {
    ...
    question_hi:
      "कौन-सी प्रॉपर्टी ग्रिड पंक्तियों के स्थान को परिभाषित करती है?",
  ...
  },
  {
    num: 26,
    question_en:
      "Which property controls how grid items stretch to fill grid cells?",
    question_hi:
      "कौन-सी प्रॉपर्टी ग्रिड आइटम्स को ग्रिड सेल्स भरने के लिए फैलाती है?",
    options_en: [
      "align-self",
      "justify-self",
      "align-content",
  ...
  },
  {
    num: 30,
    question_en:
      "Which property can be used to name multiple grid areas in one declaration?",
    question_hi:
      "एक डिक्लेरेशन में कई ग्रिड क्षेत्रों को नामित करने के लिए कौन-सी प्रॉपर्टी का उपयोग किया जा सकता है?",
    options_en: [
      "grid-template-areas",
      "grid-area",
      "grid-template-columns",
  ...
  },
  {
    num: 31,
    question_en:
      "Which CSS unit represents the fraction of the available space in grid?",
    question_hi:
      "ग्रिड में उपलब्ध स्थान के हिस्से को कौन-सी CSS यूनिट दर्शाती है?",
    options_en: ["fr", "px", "em", "%"],
    options_hi: ["fr", "px", "em", "%"],
    answer_en: "fr",
    answer_hi: "fr",
  ...
  },
  {
    num: 33,
    question_en:
      "Which property controls the alignment of the entire grid container on the column axis?",
    question_hi:
      "कौन-सी प्रॉपर्टी कॉलम अक्ष पर पूरे ग्रिड कंटेनर का संरेखण नियंत्रित करती है?",
    options_en: [
      "justify-content",
      "align-content",
      "justify-items",
  ...
  },
  {
    ...
    question_hi:
      "कौन-सी प्रॉपर्टी अप्रत्यक्ष ग्रिड कॉलम्स का आकार निर्दिष्ट करती है?",
    options_en: [
      "grid-auto-columns",
      "grid-auto-rows",
      "grid-template-columns",
  ...
  },
  {
    num: 38,
    question_en:
      "What value of 'grid-auto-flow' causes grid items to fill by column?",
    question_hi:
      "'grid-auto-flow' का कौन-सा मान आइटम्स को कॉलम अनुसार भरने के लिए होता है?",
  ...
  },
  {
    num: 39,
    question_en:
      "Which property allows a grid item to be placed in multiple areas?",
    question_hi:
      "कौन-सी प्रॉपर्टी एक ग्रिड आइटम को कई क्षेत्रों में रखने की अनुमति देती है?",
    options_en: [
      "grid-area",
      "grid-column-start",
      "grid-row-start",
  ...
  },
  {
    num: 40,
    question_en:
      "How do you define a 4 by 3 grid using grid-template-columns and grid-template-rows?",
    question_hi:
      "ग्रिड-टेम्प्लेट-कॉलम्स और ग्रिड-टेम्प्लेट-रोस का उपयोग करके 4 x 3 ग्रिड कैसे परिभाषित करते हैं?",
    options_en: [
  ...
  },
  {
    num: 42,
    question_en:
      "Which property controls the vertical alignment of grid items inside their cells?",
    question_hi:
      "ग्रिड आइटम्स के सेल्स के अंदर लंबवत संरेखण कौन-सी प्रॉपर्टी नियंत्रित करती है?",
  ...
  },
  {
    num: 43,
    question_en:
      "What value of 'grid-template-columns' creates three columns of equal width?",
    question_hi:
      "'grid-template-columns' का कौन-सा मान तीन बराबर चौड़ाई वाले कॉलम बनाता है?",
    options_en: [
      "repeat(3, 1fr)",
      "auto auto auto",
      "100px 100px 100px",
  ...
  },
  {
    num: 44,
    question_en:
      "Which property specifies how the grid auto-placement algorithm works?",
    question_hi:
      "कौन-सी प्रॉपर्टी ग्रिड ऑटो-प्लेसमेंट एल्गोरिदम को नियंत्रित करती है?",
    options_en: [
      "grid-auto-flow",
      "grid-auto-columns",
      "grid-auto-rows",
  ...
  },
  {
    ...
    options_hi: [
      "ग्रिड-टेम्प्लेट-एरियास का उपयोग करके",
      "ग्रिड-एरिया का उपयोग करके",
      "ग्रिड-गैप का उपयोग करके",
      "ग्रिड-ऑटो-फ्लो का उपयोग करके",
    ],
  ...
  },
  {
    num: 46,
    question_en:
      "Which property controls the horizontal alignment of grid items inside their cells?",
    question_hi:
      "ग्रिड आइटम्स के सेल्स के अंदर क्षैतिज संरेखण कौन-सी प्रॉपर्टी नियंत्रित करती है?",
  ...
  },
  {
    ...
    question_hi:
      "ग्रिड कॉलम्स के बीच गैप को नियंत्रित करने के लिए कौन-सी प्रॉपर्टी उपयोग की जाती है?",
