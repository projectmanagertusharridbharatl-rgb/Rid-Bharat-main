const questions = [
  ...
  },
  {
    ...
    question_hi:
      "बैकग्राउंड इमेज जोड़ने के लिए कौन सी प्रॉपर्टी उपयोग की जाती है?",
    options_en: [
      "background-image",
      "background-color",
      "image",
  ...
  },
  {
    num: 7,
    question_en:
      "Which CSS function defines colors using hue, saturation, and lightness?",
    question_hi:
      "कौन सा CSS फंक्शन ह्यू, सैचुरेशन और लाइटनेस का उपयोग करके रंग परिभाषित करता है?",
  ...
  },
  {
    num: 8,
    question_en:
      "How can you make a background image cover the entire element?",
    ...
    options_hi: [
      ...
      "बैकग्राउंड-पोजीशन: सेंटर",
      "बैकग्राउंड-अटैचमेंट: फिक्स्ड",
    ],
  ...
  },
  {
    ...
    options_en: [
      ...
      "Repeats image both ways",
    ],
    options_hi: [
      "इमेज को दोहराने से रोकता है",
      "इमेज को क्षैतिज रूप से दोहराता है",
      "इमेज को लंबवत दोहराता है",
      "इमेज को दोनों दिशाओं में दोहराता है",
    ],
  ...
  },
  {
    ...
    question_hi:
      "कौन सी प्रॉपर्टी बैकग्राउंड इमेज की स्थिति नियंत्रित करती है?",
    options_en: [
      "background-position",
      "background-size",
      "background-repeat",
  ...
  },
  {
    num: 12,
    question_en:
      "Which CSS gradient type transitions colors from one side to another horizontally?",
    question_hi:
      "कौन सा CSS ग्रेडियंट प्रकार रंगों को एक तरफ से दूसरी तरफ क्षैतिज रूप से स्थानांतरित करता है?",
    options_en: [
  ...
  },
  {
    ...
    question_hi:
      "कौन सी प्रॉपर्टी बैकग्राउंड इमेज के आकार को नियंत्रित करती है?",
    options_en: [
      "background-size",
      "background-position",
      "background-repeat",
  ...
  },
  {
    ...
    question_hi:
      "कौन सा फॉर्मेट रंगों को अपारदर्शिता के साथ निर्दिष्ट करने की अनुमति देता है?",
  ...
  },
  {
    num: 17,
    question_en:
      "What is the correct syntax for applying a linear gradient as background?",
    question_hi:
      "बैकग्राउंड के रूप में लिनियर ग्रेडियंट लागू करने के लिए सही सिंटैक्स क्या है?",
    options_en: [
      "background: linear-gradient(to right, red, yellow);",
      "background-color: linear-gradient(red, yellow);",
      "background-image: gradient(red, yellow);",
      "background-style: linear-gradient(red, yellow);",
    ],
    options_hi: [
      "background: linear-gradient(to right, red, yellow);",
      "background-color: linear-gradient(red, yellow);",
  ...
  },
  {
    num: 18,
    question_en:
      "Which CSS property is used to fix the background image during scroll?",
    question_hi:
      "स्क्रॉल के दौरान बैकग्राउंड इमेज को फिक्स करने के लिए कौन सी CSS प्रॉपर्टी का उपयोग होता है?",
    options_en: [
      "background-attachment",
      "background-position",
      "background-repeat",
  ...
  },
  {
    num: 20,
    question_en:
      "Which property can be used to set multiple background images?",
    question_hi:
      "कौन सी प्रॉपर्टी का उपयोग एक साथ कई बैकग्राउंड इमेज सेट करने के लिए किया जा सकता है?",
    options_en: [
      "background-image",
      "background-color",
      "background-repeat",
  ...
  },
  {
    num: 21,
    question_en:
      "What value for 'background-repeat' repeats the image both horizontally and vertically?",
    question_hi:
      "'background-repeat' का कौन सा मान इमेज को क्षैतिज और लंबवत दोनों रूपों में दोहराता है?",
  ...
  },
  {
    num: 22,
    question_en:
      "Which property adjusts the starting point of a background image?",
    question_hi:
      "कौन सी प्रॉपर्टी बैकग्राउंड इमेज के आरंभ बिंदु को समायोजित करती है?",
    options_en: [
      "background-position",
      "background-size",
      "background-repeat",
  ...
  },
  {
    ...
    question_hi:
      "कौन सा CSS रंग प्रारूप ह्यू वैल्यू के लिए डिग्री का उपयोग करता है?",
    options_en: ["HSL", "RGB", "HEX", "RGBA"],
    options_hi: ["HSL", "RGB", "HEX", "RGBA"],
    answer_en: "HSL",
    answer_hi: "HSL",
  ...
  },
  {
    num: 25,
    question_en:
      "Which property controls how background images scroll with the page?",
    question_hi:
      "कौन सी प्रॉपर्टी कंट्रोल करती है कि बैकग्राउंड इमेज पेज के साथ कैसे स्क्रॉल होती है?",
    options_en: [
      "background-attachment",
      "background-position",
      "background-repeat",
  ...
  },
  {
    num: 26,
    question_en:
      "Which CSS property controls the background image’s attachment behavior?",
    question_hi:
      "कौन सी CSS प्रॉपर्टी बैकग्राउंड इमेज के अटैचमेंट व्यवहार को नियंत्रित करती है?",
    options_en: [
      "background-attachment",
      "background-position",
      "background-repeat",
  ...
  },
  {
    num: 27,
    question_en:
      "Which value of background-attachment keeps the background fixed during scroll?",
    question_hi:
      "background-attachment का कौन सा मान स्क्रॉल के दौरान बैकग्राउंड को फिक्स रखता है?",
  ...
  },
  {
    ...
    options_en: [
      ...
      "Repeat of the background image",
      "Attachment of the background image",
    ],
    options_hi: [
      "बैकग्राउंड इमेज की स्थिति",
      "बैकग्राउंड इमेज का आकार",
      "बैकग्राउंड इमेज का रिपीट",
      "बैकग्राउंड इमेज का अटैचमेंट",
    ],
  ...
  },
  {
    num: 30,
    question_en:
      "Which CSS property allows multiple backgrounds on one element?",
    question_hi:
      "कौन सी CSS प्रॉपर्टी एक एलिमेंट पर कई बैकग्राउंड की अनुमति देती है?",
    options_en: [
      "background-image",
      "background-color",
      "background-repeat",
  ...
  },
  {
    ...
    options_en: [
      "Scales the image to fit inside the element",
      "Scales the image to cover the element",
      "Repeats the background image",
      "Positions the background image",
    ],
    options_hi: [
      "इमेज को एलिमेंट के अंदर फिट करने के लिए स्केल करता है",
      "इमेज को एलिमेंट कवर करने के लिए स्केल करता है",
      "बैकग्राउंड इमेज दोहराता है",
      "बैकग्राउंड इमेज की पोजीशन सेट करता है",
    ],
  ...
  },
  {
    ...
    question_hi:
      "रेडियल ग्रेडियंट के लिए कौन सा CSS फंक्शन उपयोग किया जाता है?",
    options_en: [
      "radial-gradient()",
      "linear-gradient()",
      "conic-gradient()",
  ...
  },
  {
    num: 37,
    question_en:
      "How do you set the background image position to the top right corner?",
    ...
    options_hi: [
      "बैकग्राउंड-पोजीशन: टॉप राइट",
      "बैकग्राउंड-पोजीशन: बॉटम लेफ्ट",
      "बैकग्राउंड-पोजीशन: सेंटर",
      "बैकग्राउंड-पोजीशन: लेफ्ट टॉप",
    ],
  ...
  },
  {
    ...
    options_hi: [
      "बैकग्राउंड इमेज को क्षैतिज रूप से दोहराता है",
      "बैकग्राउंड इमेज को लंबवत दोहराता है",
      "दोहराव रोकता है",
      "क्षैतिज और लंबवत दोनों में दोहराता है",
    ],
  ...
  },
  {
    ...
    options_en: [
      ...
      "Places image at top left",
      "Repeats image",
      "Fixes image in place",
    ],
    options_hi: [
      "बैकग्राउंड इमेज को केंद्रित करता है",
      "इमेज को टॉप लेफ्ट पर रखता है",
      "इमेज दोहराता है",
      "इमेज को फिक्स करता है",
    ],
  ...
  },
  {
    num: 42,
    question_en:
      "Which CSS property can add a transparent overlay on a background color?",
    question_hi:
      "कौन सी CSS प्रॉपर्टी बैकग्राउंड कलर पर पारदर्शी ओवरले जोड़ सकती है?",
    options_en: [
  ...
  },
  {
    ...
    options_en: [
      "Sets full transparency",
      "Sets white color",
      "Sets black color",
      "Sets semi-transparency",
    ],
    options_hi: [
      "पूर्ण पारदर्शिता सेट करता है",
      "सफेद रंग सेट करता है",
      "काला रंग सेट करता है",
      "सेमी-पारदर्शिता सेट करता है",
    ],
  ...
  },
  {
    num: 44,
    question_en:
      "Which property is used to position background images relative to the element’s content box?",
    question_hi:
      "कौन सी प्रॉपर्टी बैकग्राउंड इमेज को एलिमेंट के कंटेंट बॉक्स के सापेक्ष पोजीशन करती है?",
    options_en: [
      "background-origin",
      "background-position",
      "background-attachment",
  ...
  },
  {
    ...
    options_hi: [
      "जहां बैकग्राउंड पेंट किया जाता है",
      "बैकग्राउंड इमेज का आकार",
      "बैकग्राउंड पोजीशन",
      "बैकग्राउंड रिपीट",
    ],
  ...
  },
  {
    num: 46,
    question_en:
      "Which of the following is NOT a valid background-repeat value?",
  ...
  },
  {
    num: 47,
    question_en:
      "How can you set a transparent background using the 'transparent' keyword?",
    question_hi:
      "'transparent' कीवर्ड का उपयोग करके पारदर्शी बैकग्राउंड कैसे सेट करें?",
    options_en: [
  ...
  },
  {
    num: 48,
    question_en:
      "Which property controls the size of a background image without stretching it?",
    question_hi:
      "कौन सी प्रॉपर्टी बिना खींचे बैकग्राउंड इमेज के आकार को नियंत्रित करती है?",
    options_en: [
      "background-size",
      "background-position",
      "background-repeat",
  ...
  },
  {
    ...
    options_en: [
      "Separate image URLs with commas in background-image",
      "Use multiple background-image properties",
      "Use background-repeat multiple times",
      "Use multiple background-position properties",
    ],
    options_hi: [
      "background-image में कॉमा से अलग-अलग इमेज URLs",
      "कई background-image प्रॉपर्टी का उपयोग",
      "background-repeat कई बार उपयोग करें",
      "कई background-position प्रॉपर्टी का उपयोग",
    ],
  ...
  },
  {
    ...
    question_hi:
      "कौन सा CSS फंक्शन आपको कोनिक ग्रेडियंट बनाने की अनुमति देता है?",
    options_en: [
      "conic-gradient()",
      "radial-gradient()",
      "linear-gradient()",
