const questions = [
  {
    ...
    options_hi: [
      ...
      "कंप्यूटर स्टाइल शीट्स",
      "क्रिएटिव स्टाइल शीट्स",
      "कलरफुल स्टाइल शीट्स",
    ],
  ...
  },
  {
    ...
    question_hi:
      "पृष्ठभूमि रंग बदलने के लिए कौन सी प्रॉपर्टी का उपयोग किया जाता है?",
  ...
  },
  {
    ...
    question_hi:
      "फॉन्ट का आकार सेट करने के लिए कौन सी प्रॉपर्टी का उपयोग किया जाता है?",
  ...
  },
  {
    ...
    question_hi:
      "टेक्स्ट संरेखण बदलने के लिए कौन सी प्रॉपर्टी का उपयोग किया जाता है?",
  ...
  },
  {
    num: 10,
    question_en:
      "Which property is used to change the visibility of an element?",
    question_hi:
      "किस प्रॉपर्टी का उपयोग तत्व की दृश्यता बदलने के लिए किया जाता है?",
  ...
  },
  {
    num: 11,
    question_en:
      "Which property is used to hide an element but still keep its space?",
    question_hi:
      "कौन सी प्रॉपर्टी तत्व को छिपाने के लिए उपयोग होती है लेकिन उसका स्थान बनाए रखती है?",
    options_en: [
      "visibility: hidden",
      "display: none",
      "opacity: 0",
  ...
  },
  {
    ...
    question_hi:
      "अक्षरों के बीच की जगह को नियंत्रित करने वाली प्रॉपर्टी कौन सी है?",
    options_en: [
      "letter-spacing",
      "word-spacing",
      "text-spacing",
  ...
  },
  {
    ...
    question_hi:
      "शब्दों के बीच की जगह को नियंत्रित करने वाली प्रॉपर्टी कौन सी है?",
    options_en: [
      "word-spacing",
      "letter-spacing",
      "text-spacing",
  ...
  },
  {
    num: 18,
    question_en:
      "Which property adds space inside an element, between the content and the border?",
    question_hi:
      "कौन सी प्रॉपर्टी तत्व के अंदर, कंटेंट और बॉर्डर के बीच जगह जोड़ती है?",
  ...
  },
  {
    num: 19,
    question_en:
      "Which property adds space outside an element, between the element and other elements?",
    question_hi:
      "कौन सी प्रॉपर्टी तत्व के बाहर, उसके और दूसरे तत्वों के बीच जगह जोड़ती है?",
  ...
  },
  {
    ...
    question_hi:
      "सूची आइटम मार्कर का स्टाइल सेट करने वाली प्रॉपर्टी कौन सी है?",
    options_en: [
      "list-style-type",
      "list-style",
      "list-marker",
  ...
  },
  {
    ...
    question_hi:
      "होवर पर कर्सर बदलने के लिए कौन सी प्रॉपर्टी का उपयोग किया जाता है?",
  ...
  },
  {
    ...
    question_hi:
      "कौन सी प्रॉपर्टी तत्व के डिस्प्ले व्यवहार को नियंत्रित करती है?",
  ...
  },
  {
    ...
    question_hi:
      "कौन सी प्रॉपर्टी तत्व की ऊंचाई सेट करने के लिए उपयोग होती है?",
  ...
  },
  {
    ...
    question_hi:
      "कौन सी प्रॉपर्टी तत्व की चौड़ाई सेट करने के लिए उपयोग होती है?",
  ...
  },
  {
    ...
    question_hi:
      "फ्लेक्स आइटम्स के क्रम को नियंत्रित करने वाली प्रॉपर्टी कौन सी है?",
  ...
  },
  {
    ...
    question_hi:
      "सूची मार्कर के प्रकार को निर्दिष्ट करने वाली प्रॉपर्टी कौन सी है?",
  ...
  },
  {
    ...
    question_hi:
      "टेक्स्ट की लाइनों के बीच की जगह को नियंत्रित करने वाली प्रॉपर्टी कौन सी है?",
    options_en: [
      "line-height",
      "letter-spacing",
      "word-spacing",
  ...
  },
  {
    ...
    question_hi:
      "टेक्स्ट को अपरकेस (बड़े अक्षरों) में बदलने के लिए कौन सी प्रॉपर्टी उपयोग होती है?",
    options_en: [
      "text-transform",
      "text-uppercase",
      "text-style",
  ...
  },
  {
    ...
    question_hi:
      "ओवरफ्लो सामग्री की दृश्यता को नियंत्रित करने वाली प्रॉपर्टी कौन सी है?",
  ...
  },
  {
    ...
    question_hi:
      "पोजीशन्ड तत्वों के स्टैकिंग ऑर्डर को सेट करने वाली प्रॉपर्टी कौन सी है?",
  ...
  },
  {
    num: 34,
    question_en:
      "Which property is used to float an element to the left or right?",
    question_hi:
      "तत्व को बाएं या दाएं फ्लोट करने के लिए कौन सी प्रॉपर्टी उपयोग होती है?",
  ...
  },
  {
    ...
    question_hi:
      "पैराग्राफ के बीच की जगह को नियंत्रित करने वाली प्रॉपर्टी कौन सी है?",
  ...
  },
  {
    num: 38,
    question_en:
      "Which property is used to control the cursor when hovering over an element?",
    question_hi:
      "कौन सी प्रॉपर्टी तत्व पर होवर करते समय कर्सर को नियंत्रित करती है?",
    options_en: ["cursor", "pointer", "hover", "mouse"],
    options_hi: ["cursor", "pointer", "hover", "mouse"],
    answer_en: "cursor",
    answer_hi: "कर्सर",
  ...
  },
  {
    num: 39,
    question_en:
      "Which property controls the visibility of an element without removing it from the document flow?",
    question_hi:
      "कौन सी प्रॉपर्टी तत्व की दृश्यता को नियंत्रित करती है बिना उसे डॉक्यूमेंट फ्लो से हटाए?",
  ...
  },
  {
    num: 41,
    question_en:
      "Which property specifies whether an element is fixed, absolute, relative, or static?",
    question_hi:
      "कौन सी प्रॉपर्टी निर्दिष्ट करती है कि तत्व fixed, absolute, relative या static है?",
  ...
  },
  {
    num: 42,
    question_en:
      "Which property controls the text decoration like underline or line-through?",
    question_hi:
      "कौन सी प्रॉपर्टी टेक्स्ट की सजावट जैसे अंडरलाइन या लाइन-थ्रू को नियंत्रित करती है?",
    options_en: [
      "text-decoration",
      "text-style",
      "font-decoration",
  ...
  },
  {
    ...
    question_hi:
      "कौन सी प्रॉपर्टी बॉर्डर रेडियस के स्टाइल को नियंत्रित करती है?",
    options_en: [
      "border-radius",
      "border-style",
      "border-width",
  ...
  },
  {
    ...
    question_hi:
      "टेबल में सेल्स के बीच की जगह को नियंत्रित करने वाली प्रॉपर्टी कौन सी है?",
  ...
  },
  {
    num: 45,
    question_en:
      "Which property defines how an element's content is displayed when it overflows the element's box?",
    question_hi:
      "जब तत्व की सामग्री उसके बॉक्स से बाहर निकलती है तो उसे कैसे प्रदर्शित किया जाता है, यह कौन सी प्रॉपर्टी निर्धारित करती है?",
    options_en: ["overflow", "visibility", "display", "content"],
    options_hi: ["overflow", "visibility", "display", "content"],
    answer_en: "overflow",
    answer_hi: "ओवरफ्लो",
  ...
  },
  {
    num: 47,
    question_en:
      "Which property sets the indentation of the first line of text?",
  ...
  },
  {
    num: 48,
    question_en:
      "Which property is used to set the minimum width of an element?",
    question_hi:
      "कौन सी प्रॉपर्टी तत्व की न्यूनतम चौड़ाई सेट करने के लिए उपयोग होती है?",
  ...
  },
  {
    num: 49,
    question_en:
      "Which property is used to set the maximum height of an element?",
    question_hi:
      "कौन सी प्रॉपर्टी तत्व की अधिकतम ऊंचाई सेट करने के लिए उपयोग होती है?",
