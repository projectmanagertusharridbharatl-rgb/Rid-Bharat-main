const questions = [
  ...
  },
  {
    num: 4,
    question_en:
      "What is the syntax for declaring a CSS variable named --main-color with the value red?",
    question_hi:
      "CSS वेरिएबल --main-color को रेड मान के साथ कैसे घोषित करते हैं?",
    options_en: [
      "--main-color: red;",
      "var(--main-color: red);",
      "$main-color: red;",
  ...
  },
  {
    ...
    question_hi:
      "क्या CSS वेरिएबल पैरेंट एलिमेंट से मान विरासत में ले सकते हैं?",
    options_en: [
      "Yes",
      "No",
      "Only with !important",
  ...
  },
  {
    num: 6,
    question_en:
      "Which CSS function is used to provide a fallback value for a variable?",
    question_hi:
      "CSS में fallback value देने के लिए कौन सा फंक्शन उपयोग किया जाता है?",
    options_en: ["var()", "fallback()", "default()", "value()"],
    options_hi: ["var()", "fallback()", "default()", "value()"],
    answer_en: "var()",
    answer_hi: "var()",
    attempted: false,
    selected: "",
  },
  {
    ...
    question_hi:
      "अगर CSS वेरिएबल परिभाषित नहीं है लेकिन उपयोग किया गया है तो क्या होगा?",
    options_en: [
  ...
  },
  {
    num: 9,
    question_en:
      "How do you override a CSS variable value in a specific selector?",
    question_hi:
      "किसी विशेष सेलेक्टर में CSS वेरिएबल का मान कैसे ओवरराइड करते हैं?",
    options_en: [
  ...
  },
  {
    ...
    options_en: ["Yes", "No", "Depends on browser", "Only in selectors"],
    options_hi: [
      "हाँ",
      "नहीं",
  ...
  },
  {
    num: 11,
    question_en:
      "Which pseudo-class is commonly used with CSS variables for theming?",
    question_hi:
      "थीमिंग के लिए CSS वेरिएबल के साथ कौन सा pseudo-class आमतौर पर उपयोग होता है?",
    options_en: [":root", ":hover", ":active", ":focus"],
    options_hi: [":root", ":hover", ":active", ":focus"],
    answer_en: ":root",
    answer_hi: ":root",
    attempted: false,
    selected: "",
  },
  {
    ...
    question_hi:
      "क्या CSS वेरिएबल मीडिया क्वेरी के अंदर उपयोग किए जा सकते हैं?",
  ...
  },
  {
    num: 15,
    question_en:
      "Which property can be used with CSS variables for color theming?",
    question_hi:
      "रंग थीमिंग के लिए CSS वेरिएबल के साथ कौन सी प्रॉपर्टी उपयोग की जाती है?",
    options_en: ["color", "font-size", "margin", "border-style"],
    options_hi: ["color", "font-size", "margin", "border-style"],
    answer_en: "color",
    answer_hi: "color",
    attempted: false,
    selected: "",
  },
  {
    ...
    options_en: ["Yes", "No", "Only with jQuery", "Only in some browsers"],
    options_hi: ["हाँ", "नहीं", "केवल jQuery से", "कुछ ब्राउज़र में ही"],
    answer_en: "Yes",
    answer_hi: "हाँ",
    attempted: false,
    selected: "",
  },
  {
    num: 17,
    question_en:
      "Which method is used in JavaScript to change a CSS variable's value?",
    question_hi:
      "जावास्क्रिप्ट में CSS वेरिएबल का मान बदलने के लिए कौन सा मेथड उपयोग होता है?",
    options_en: [
      "setProperty()",
      "changeVariable()",
      "setVariable()",
  ...
  },
  {
    num: 18,
    question_en:
      "How do you remove a CSS variable from an element using JavaScript?",
  ...
  },
  {
    ...
    question_hi:
      "क्या CSS वेरिएबल का उपयोग फॉन्ट साइज को परिभाषित करने के लिए किया जा सकता है?",
    options_en: [
      "Yes",
      "No",
  ...
  },
  {
    ...
    options_en: ["Yes", "No", "Only base64 encoded URLs", "Only local URLs"],
    options_hi: [
      "हाँ",
      "नहीं",
  ...
  },
  {
    ...
    question_hi:
      "क्या CSS वेरिएबल्स को CSS ट्रांजिशन्स से एनिमेट किया जा सकता है?",
    options_en: ["No", "Yes", "Only with JavaScript", "Only in Firefox"],
    options_hi: ["नहीं", "हाँ", "केवल जावास्क्रिप्ट से", "सिर्फ Firefox में"],
    answer_en: "No",
    answer_hi: "नहीं",
    attempted: false,
    selected: "",
  ...
  },
  {
    ...
    question_hi:
      "पाठ की लाइनों के बीच की दूरी को नियंत्रित करने के लिए कौन-सी CSS प्रॉपर्टी का उपयोग होता है?",
    options_en: [
      "line-height",
      "letter-spacing",
      "word-spacing",
  ...
  },
  {
    num: 28,
    question_en:
      "How can you apply a style to all elements of a specific class in CSS?",
    question_hi:
      "CSS में किसी विशिष्ट क्लास के सभी एलिमेंट्स को स्टाइल कैसे लागू करते हैं?",
    options_en: [
  ...
  },
  {
    ...
    question_hi:
      "किस प्रॉपर्टी का उपयोग एलिमेंट के फॉन्ट को बदलने के लिए किया जाता है?",
    options_en: ["font-family", "font-style", "font-weight", "font-variant"],
    options_hi: ["font-family", "font-style", "font-weight", "font-variant"],
  ...
  },
  {
    ...
    question_hi:
      "किस प्रॉपर्टी का उपयोग एलिमेंट की बॉर्डर के अंदर स्पेस जोड़ने के लिए किया जाता है?",
    options_en: ["padding", "margin", "border-spacing", "gap"],
    options_hi: ["padding", "margin", "border-spacing", "gap"],
    answer_en: "padding",
    answer_hi: "padding",
    attempted: false,
    selected: "",
  ...
  },
  {
    num: 33,
    question_en:
      "Which property controls the visibility of an element but keeps the space it occupies?",
    question_hi:
      "कौन-सी प्रॉपर्टी एलिमेंट की दृश्यता नियंत्रित करती है लेकिन उसकी जगह को बरकरार रखती है?",
    options_en: ["visibility", "display", "opacity", "z-index"],
    options_hi: ["visibility", "display", "opacity", "z-index"],
  ...
  },
  {
    ...
    question_hi:
      "कौन-सी CSS प्रॉपर्टी टेक्स्ट को बोल्ड बनाने के लिए उपयोग होती है?",
    options_en: ["font-weight", "font-style", "font-variant", "text-transform"],
    options_hi: ["font-weight", "font-style", "font-variant", "text-transform"],
  ...
  },
  {
    ...
    options_hi: ["margin", "padding", "border-spacing", "gap"],
    answer_en: "margin",
    answer_hi: "margin",
    attempted: false,
    selected: "",
  ...
  },
  {
    num: 39,
    question_en:
      "Which property is used to control the size of an element’s font?",
    question_hi:
      "कौन-सी प्रॉपर्टी का उपयोग एलिमेंट के फॉन्ट के साइज को नियंत्रित करने के लिए किया जाता है?",
    options_en: ["font-size", "font-weight", "font-family", "text-size"],
    options_hi: ["font-size", "font-weight", "font-family", "text-size"],
    answer_en: "font-size",
    answer_hi: "font-size",
    attempted: false,
    selected: "",
  ...
  },
  {
    ...
    question_hi:
      "कौन-सी CSS प्रॉपर्टी एलिमेंट का बैकग्राउंड कलर बदलने के लिए उपयोग होती है?",
    options_en: [
      "background-color",
      "color",
      "background-image",
  ...
  },
  {
    num: 42,
    question_en:
      "How do you make an element take up the full width of its container?",
    question_hi:
      "किसी एलिमेंट को उसके कंटेनर की पूरी चौड़ाई लेने के लिए कैसे बनाते हैं?",
    options_en: [
      "width: 100%;",
      "width: auto;",
      "width: fit-content;",
  ...
  },
  {
    num: 43,
    question_en:
      "Which property controls the horizontal alignment of text within an element?",
    question_hi:
      "कौन-सी प्रॉपर्टी एलिमेंट के अंदर टेक्स्ट की क्षैतिज संरेखण को नियंत्रित करती है?",
    options_en: [
      "text-align",
      "vertical-align",
      "align-items",
  ...
  },
  {
    ...
    question_hi:
      "कौन-सा CSS यूनिट रूट एलिमेंट के फॉन्ट साइज के सापेक्ष होता है?",
    options_en: ["rem", "em", "px", "%"],
    options_hi: ["rem", "em", "px", "%"],
    answer_en: "rem",
    answer_hi: "rem",
    attempted: false,
    selected: "",
  },
  {
    num: 46,
    question_en:
      "Which property is used to set the space between columns in a CSS Grid layout?",
    question_hi:
      "CSS Grid लेआउट में कॉलम के बीच स्पेस सेट करने के लिए कौन-सी प्रॉपर्टी का उपयोग होता है?",
    options_en: ["column-gap", "row-gap", "grid-gap", "gap"],
    options_hi: ["column-gap", "row-gap", "grid-gap", "gap"],
  ...
  },
  {
    num: 49,
    question_en:
      "Which pseudo-class is used to select an element when the mouse pointer is over it?",
    question_hi:
      "कौन-सा pseudo-class उस एलिमेंट को सेलेक्ट करता है जिस पर माउस पॉइंटर होता है?",
