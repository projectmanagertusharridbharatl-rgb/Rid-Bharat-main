const questions = [
  {
    ...
    options_en: [
      ...
      "Text, Border, Padding, Margin",
      "Content, Text, Border, Margin",
      "Padding, Margin, Border, Font",
    ],
    options_hi: [
      "कंटेंट, पैडिंग, बॉर्डर, मार्जिन",
      "टेक्स्ट, बॉर्डर, पैडिंग, मार्जिन",
      "कंटेंट, टेक्स्ट, बॉर्डर, मार्जिन",
      "पैडिंग, मार्जिन, बॉर्डर, फ़ॉन्ट",
    ],
  ...
  },
  {
    num: 2,
    question_en:
      "Which part of the Box Model is used to create space inside the element, between the content and the border?",
    question_hi:
      "बॉक्स मॉडल का कौन सा भाग एलिमेंट के अंदर कंटेंट और बॉर्डर के बीच जगह बनाता है?",
  ...
  },
  {
    num: 3,
    question_en:
      "Which part of the Box Model creates space outside the border?",
  ...
  },
  {
    num: 4,
    question_en:
      "Which property sets the thickness of the border in the Box Model?",
  ...
  },
  {
    num: 6,
    question_en:
      "Which CSS property controls the space between the border and the content?",
    question_hi:
      "कौन सी CSS प्रॉपर्टी बॉर्डर और कंटेंट के बीच जगह को नियंत्रित करती है?",
  ...
  },
  {
    num: 7,
    question_en:
      "How can you make the width and height include padding and border using box-sizing?",
    question_hi:
      "आप बॉक्स-साइजिंग का उपयोग करके कैसे चौड़ाई और ऊँचाई में पैडिंग और बॉर्डर शामिल कर सकते हैं?",
    options_en: [
    ...
    options_hi: [
      "box-sizing को border-box पर सेट करें",
      "box-sizing को content-box पर सेट करें",
      "चौड़ाई और ऊँचाई मैन्युअली सेट करें",
      "मार्जिन प्रॉपर्टी का उपयोग करें",
    ],
  ...
  },
  {
    num: 8,
    question_en:
      "Which property is used to add space outside the element’s border?",
    question_hi:
      "एलिमेंट के बॉर्डर के बाहर जगह जोड़ने के लिए कौन सी प्रॉपर्टी का उपयोग होता है?",
  ...
  },
  {
    num: 9,
    question_en:
      "If you want to add a red border of 2px thickness around an element, which CSS property would you use?",
    question_hi:
      "अगर आप किसी एलिमेंट के चारों ओर 2px मोटी लाल बॉर्डर जोड़ना चाहते हैं तो कौन सी CSS प्रॉपर्टी उपयोग करेंगे?",
    options_en: [
      "border: 2px solid red",
      "border-width: 2px red solid",
  ...
  },
  {
    num: 10,
    question_en:
      "Which property defines the inner content area size of the box?",
    question_hi:
      "कौन सी प्रॉपर्टी बॉक्स के अंदर कंटेंट एरिया का आकार निर्धारित करती है?",
  ...
  },
  {
    ...
    options_en: [
      "Padding and border are included in width and height",
      "Padding and border are excluded from width and height",
      "Only border is included",
      "Only padding is included",
    ],
    options_hi: [
      "पैडिंग और बॉर्डर चौड़ाई और ऊँचाई में शामिल होते हैं",
      "पैडिंग और बॉर्डर चौड़ाई और ऊँचाई से बाहर होते हैं",
      "केवल बॉर्डर शामिल होता है",
      "केवल पैडिंग शामिल होती है",
    ],
  ...
  },
  {
    num: 13,
    question_en:
      "How do you create space between adjacent elements using the Box Model?",
    question_hi:
      "बॉक्स मॉडल का उपयोग करके आसन्न एलिमेंट्स के बीच जगह कैसे बनाते हैं?",
    options_en: [
      "Using margin",
      "Using padding",
      "Using border",
    ...
    options_hi: [
      "मार्जिन का उपयोग करके",
      "पैडिंग का उपयोग करके",
      "बॉर्डर का उपयोग करके",
      "कंटेंट का उपयोग करके",
    ],
  ...
  },
  {
    num: 14,
    question_en:
      "Which property can change the style of the border (solid, dotted, dashed)?",
    question_hi:
      "कौन सी प्रॉपर्टी बॉर्डर की स्टाइल (सॉलिड, डॉटेड, डैश्ड) बदल सकती है?",
    options_en: [
      "border-style",
      "border-width",
      "border-color",
  ...
  },
  {
    num: 15,
    question_en:
      "What is the effect of setting margin to 'auto' on a block element?",
    question_hi:
      "ब्लॉक एलिमेंट पर मार्जिन को 'auto' सेट करने का क्या प्रभाव होता है?",
    options_en: [
    ...
    options_hi: [
      "एलिमेंट को क्षैतिज रूप से केंद्रित करता है",
      "एलिमेंट को बाएँ संरेखित करता है",
      "एलिमेंट को दाएँ संरेखित करता है",
      "मार्जिन हटाता है",
    ],
  ...
  },
  {
    num: 18,
    question_en:
      "Which CSS property can be used to add rounded corners to a box?",
    question_hi:
      "बॉक्स के कोनों को गोल बनाने के लिए कौन सी CSS प्रॉपर्टी इस्तेमाल होती है?",
  ...
  },
  {
    ...
    options_en: [
      "Adds a line outside the border",
      "Adds space inside the box",
      "Changes the box size",
      "Changes content color",
    ],
    options_hi: [
      "बॉर्डर के बाहर एक लाइन जोड़ती है",
      "बॉक्स के अंदर जगह जोड़ती है",
      "बॉक्स का आकार बदलती है",
      "कंटेंट का रंग बदलती है",
    ],
  ...
  },
  {
    num: 21,
    question_en:
      "Which property can control the minimum width and height of a box?",
    question_hi:
      "कौन सी प्रॉपर्टी बॉक्स की न्यूनतम चौड़ाई और ऊँचाई को नियंत्रित करती है?",
    options_en: [
  ...
  },
  {
    ...
    options_en: [
      ...
      "Both are inside the content",
      "Both are outside the border",
    ],
    options_hi: [
      "मार्जिन बॉर्डर के बाहर होता है; पैडिंग बॉर्डर के अंदर होता है",
      "मार्जिन बॉर्डर के अंदर होता है; पैडिंग बॉर्डर के बाहर होता है",
      "दोनों कंटेंट के अंदर होते हैं",
      "दोनों बॉर्डर के बाहर होते हैं",
    ],
  ...
  },
  {
    num: 24,
    question_en:
      "Which property can you use to collapse the margin between two elements?",
    question_hi: "दो एलिमेंट्स के बीच मार्जिन को कैसे एकीकृत किया जा सकता है?",
    options_en: [
      "margin-collapse (does not exist)",
      "Using margin-top and margin-bottom carefully",
      "Using padding",
      "Using border",
    ],
    options_hi: [
      "margin-collapse (मौजूद नहीं है)",
      "margin-top और margin-bottom का सावधानीपूर्वक उपयोग",
      "पैडिंग का उपयोग",
      "बॉर्डर का उपयोग",
    ],
  ...
  },
  {
    ...
    options_en: [
      "Hides the content that overflows the box",
      "Shows scrollbar",
      "Increases box size",
      "Adds margin",
    ],
    options_hi: [
      "जो कंटेंट बॉक्स से बाहर जाता है उसे छिपा देता है",
      "स्क्रॉलबार दिखाता है",
  ...
  },
  {
    num: 26,
    question_en:
      "Which CSS property adds space between the border and the element’s outer edge?",
    question_hi:
      "कौन सी CSS प्रॉपर्टी बॉर्डर और एलिमेंट के बाहरी किनारे के बीच जगह जोड़ती है?",
  ...
  },
  {
    ...
    options_en: [
      "Adds 10px space inside the element around content",
      "Adds 10px space outside the element",
      "Adds 10px border",
      "Removes margin",
    ],
    options_hi: [
      "एलिमेंट के अंदर कंटेंट के चारों ओर 10px जगह जोड़ता है",
      "एलिमेंट के बाहर 10px जगह जोड़ता है",
      "10px बॉर्डर जोड़ता है",
      "मार्जिन हटाता है",
    ],
  ...
  },
  {
    num: 28,
    question_en:
      "Which property controls the transparency of the background color in the box model?",
    question_hi:
      "बॉक्स मॉडल में बैकग्राउंड रंग की पारदर्शिता को कौन सी प्रॉपर्टी नियंत्रित करती है?",
  ...
  },
  {
    num: 30,
    question_en:
      "Which CSS property can you use to change the space between the content and the border?",
    question_hi:
      "किस CSS प्रॉपर्टी से कंटेंट और बॉर्डर के बीच की जगह बदली जा सकती है?",
  ...
  },
  {
    num: 31,
    question_en:
      "How do you make the margin of an element collapse with the margin of another element?",
    question_hi:
      "किस तरह आप एक एलिमेंट का मार्जिन दूसरे एलिमेंट के मार्जिन के साथ मिलाते हैं?",
    options_en: [
      "By placing elements vertically adjacent",
      "By setting margin to zero",
      "By using padding",
      "By adding border",
    ],
    options_hi: [
      "एलिमेंट्स को ऊर्ध्वाधर रूप से एक-दूसरे के करीब रखने से",
      "मार्जिन को ज़ीरो सेट करके",
      "पैडिंग का उपयोग करके",
      "बॉर्डर जोड़कर",
    ],
  ...
  },
  {
    ...
    question_hi:
      "कौन सी प्रॉपर्टी एलिमेंट के मार्जिन को एकीकृत होने से रोक सकती है?",
  ...
  },
  {
    ...
    options_hi: [
      "बॉर्डर के बाहर एक लाइन बनाती है",
      "पैडिंग बनाती है",
      "मार्जिन जोड़ती है",
      "बैकग्राउंड रंग सेट करती है",
    ],
  ...
  },
  {
    num: 35,
    question_en:
      "Which CSS property defines how the element’s width and height are calculated?",
    question_hi:
      "कौन सी CSS प्रॉपर्टी निर्धारित करती है कि एलिमेंट की चौड़ाई और ऊँचाई कैसे गणना की जाती है?",
  ...
  },
  {
    num: 36,
    question_en:
      "If an element has 'box-sizing: content-box', what does the width property apply to?",
    question_hi:
      "अगर किसी एलिमेंट पर 'box-sizing: content-box' है, तो width प्रॉपर्टी किस पर लागू होती है?",
    options_en: [
      "Only content area",
  ...
  },
  {
    num: 37,
    question_en:
      "What effect does adding padding have on the total size of an element when box-sizing is content-box?",
    question_hi:
      "जब box-sizing content-box होता है, तो पैडिंग जोड़ने से एलिमेंट के कुल आकार पर क्या प्रभाव पड़ता है?",
    options_en: [
      "Increases total size",
      "Decreases total size",
      "No effect",
      "Sets size to zero",
    ],
    options_hi: [
  ...
  },
  {
    num: 38,
    question_en:
      "Which property adds space inside an element but outside its content area?",
    question_hi:
      "कौन सी प्रॉपर्टी एलिमेंट के अंदर लेकिन कंटेंट क्षेत्र के बाहर जगह जोड़ती है?",
  ...
  },
  {
    num: 39,
    question_en:
      "Which part of the box model is transparent by default and does not have any color?",
    question_hi:
      "बॉक्स मॉडल का कौन सा भाग डिफ़ॉल्ट रूप से पारदर्शी होता है और उसका कोई रंग नहीं होता?",
  ...
  },
  {
    num: 40,
    question_en:
      "What is the CSS shorthand property for setting all four margins at once?",
    question_hi:
      "चारों मार्जिन को एक साथ सेट करने के लिए CSS शॉर्टहैंड प्रॉपर्टी कौन सी है?",
    options_en: ["margin", "padding", "border", "outline"],
    options_hi: ["मार्जिन", "पैडिंग", "बॉर्डर", "आउटलाइन"],
    answer_en: "margin",
    answer_hi: "मार्जिन",
  ...
  },
  {
    num: 42,
    question_en:
      "Which property can be used to prevent margin collapse between two adjacent elements?",
    question_hi:
      "दो आसन्न एलिमेंट्स के बीच मार्जिन को कोलैप्स होने से रोकने के लिए कौन सी प्रॉपर्टी का उपयोग किया जा सकता है?",
  ...
  },
  {
    ...
    options_en: [
      ...
      "Width includes padding only",
      "Height includes border only",
    ],
    options_hi: [
      "चौड़ाई और ऊँचाई केवल कंटेंट शामिल करते हैं",
      "चौड़ाई और ऊँचाई कंटेंट, पैडिंग, बॉर्डर शामिल करते हैं",
      "चौड़ाई केवल पैडिंग शामिल करती है",
      "ऊँचाई केवल बॉर्डर शामिल करती है",
    ],
  ...
  },
  {
    num: 44,
    question_en:
      "How does the 'border-box' value affect the size of an element?",
    question_hi:
      "'border-box' वैल्यू एलिमेंट के आकार को कैसे प्रभावित करती है?",
    options_en: [
      "Width and height include padding and border",
      "Width and height exclude padding and border",
      "Width includes padding only",
      "Height excludes border",
    ],
    options_hi: [
      "चौड़ाई और ऊँचाई में पैडिंग और बॉर्डर शामिल होते हैं",
      "चौड़ाई और ऊँचाई में पैडिंग और बॉर्डर शामिल नहीं होते",
      "चौड़ाई में केवल पैडिंग शामिल होता है",
      "ऊँचाई में बॉर्डर शामिल नहीं होता",
    ],
  ...
  },
  {
    ...
    options_en: [
      "Content overflowing the box is visible",
      "Content overflowing the box is hidden",
      "Scrollbar is added",
      "Box size increases",
    ],
    options_hi: [
      "जो कंटेंट बॉक्स से बाहर जाता है वह दिखता है",
      "जो कंटेंट बॉक्स से बाहर जाता है वह छिपा रहता है",
      "स्क्रॉलबार जोड़ता है",
      "बॉक्स का आकार बढ़ता है",
    ],
  ...
  },
  {
    num: 47,
    question_en:
      "Which CSS property sets the space between a box's border and its adjacent boxes?",
    question_hi:
      "कौन सी CSS प्रॉपर्टी बॉक्स के बॉर्डर और उसके आस-पास के बॉक्स के बीच की जगह सेट करती है?",
    options_en: ["margin", "padding", "border-spacing", "outline"],
    options_hi: ["मार्जिन", "पैडिंग", "बॉर्डर-स्पेसिंग", "आउटलाइन"],
    answer_en: "margin",
    answer_hi: "मार्जिन",
  ...
  },
  {
    ...
    options_en: [
      "Inherits the box-sizing value from the parent",
      "Resets box-sizing to default",
      "Sets box-sizing to content-box",
      "Sets box-sizing to border-box",
    ],
    options_hi: [
      "पेरेंट से box-sizing मान को विरासत में लेता है",
      "box-sizing को डिफ़ॉल्ट पर रीसेट करता है",
      "box-sizing को content-box पर सेट करता है",
      "box-sizing को border-box पर सेट करता है",
    ],
  ...
  },
  {
    num: 49,
    question_en:
      "Which of the following affects the space outside the border but inside the parent container?",
    question_hi:
      "निम्नलिखित में से कौन बॉर्डर के बाहर लेकिन पेरेंट कंटेनर के अंदर की जगह को प्रभावित करता है?",
    options_en: ["margin", "padding", "border", "content"],
    options_hi: ["मार्जिन", "पैडिंग", "बॉर्डर", "कंटेंट"],
    answer_en: "margin",
    answer_hi: "मार्जिन",
