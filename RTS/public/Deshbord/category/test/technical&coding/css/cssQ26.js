const questions = [
  {
    ...
    options_en: [
      "To apply styles based on device properties",
      "To animate elements",
      "To create JavaScript functions",
      "To store data",
    ],
    options_hi: [
      "डिवाइस गुणों के आधार पर शैलियाँ लागू करने के लिए",
      "एलिमेंट्स को एनीमेट करने के लिए",
      "JavaScript फ़ंक्शन बनाने के लिए",
  ...
  },
  {
    ...
    question_hi:
      "मीडिया क्वेरी को परिभाषित करने के लिए कौन-सा कीवर्ड उपयोग किया जाता है?",
  ...
  },
  {
    ...
    question_hi:
      "मीडिया क्वेरी में चौड़ाई के लिए सामान्यतः कौन-सी इकाई उपयोग होती है?",
  ...
  },
  {
    ...
    options_en: [
      "By fixing widths",
      "By applying fixed layout",
      "By adapting layout to device",
      "By disabling styles",
    ],
    options_hi: [
      "चौड़ाई को स्थिर करके",
      "स्थिर लेआउट लागू करके",
      "डिवाइस के अनुसार लेआउट को अनुकूल बनाकर",
      "शैलियाँ अक्षम करके",
    ],
  ...
  },
  {
    num: 8,
    question_en:
      "Which orientation value indicates the device is held vertically?",
    question_hi:
      "कौन-सा ओरिएंटेशन मान डिवाइस के ऊर्ध्व स्थिति में होने को दर्शाता है?",
  ...
  },
  {
    ...
    options_hi: [
      "पुराने ब्राउज़रों को छोड़ने के लिए",
      "सभी ब्राउज़रों को शामिल करने के लिए",
      "विशिष्ट डिवाइस को लक्षित करने के लिए",
      "मीडिया क्वेरी को अनदेखा करने के लिए",
    ],
  ...
  },
  {
    num: 10,
    question_en:
      "Which syntax is correct for setting max-width in a media query?",
    question_hi:
      "मीडिया क्वेरी में max-width सेट करने के लिए सही सिंटैक्स क्या है?",
    options_en: [
  ...
  },
  {
    ...
    question_hi:
      "कौन-सी विशेषता पोर्ट्रेट और लैंडस्केप दोनों के लिए शैलियाँ लागू करने देती है?",
  ...
  },
  {
    ...
    question_hi:
      "यदि कोई मीडिया प्रकार निर्दिष्ट नहीं किया गया है, तो डिफ़ॉल्ट मीडिया प्रकार क्या होता है?",
  ...
  },
  {
    ...
    question_hi:
      "कौन-सी प्रॉपर्टी छोटे स्क्रीन पर कंटेंट को छिपाने में मदद करती है?",
    options_en: [
      "display: none",
      "opacity: 0",
      "visibility: hidden",
  ...
  },
  {
    ...
    question_hi:
      "प्रिंटेड दस्तावेजों के लिए कौन-सा मीडिया टाइप उपयोग किया जाता है?",
  ...
  },
  {
    ...
    options_hi: [
      "मीडिया क्वेरी का उपयोग करता है",
      "लेआउट को समायोजित करता है",
      "यूज़र अनुभव को बेहतर बनाता है",
      "उपरोक्त सभी",
    ],
  ...
  },
  {
    ...
    options_en: [
      "Applies only to screens wider than 768px",
      "Applies to all devices",
      "Applies below 768px",
      "Applies to printers",
    ],
    options_hi: [
      "केवल 768px से बड़ी स्क्रीन पर लागू होता है",
      "सभी डिवाइसों पर लागू होता है",
      "768px से कम पर लागू होता है",
      "प्रिंटर पर लागू होता है",
    ],
  ...
  },
  {
    ...
    question_hi:
      "कौन-सा मीडिया फीचर रेजोल्यूशन की जांच के लिए उपयोग किया जाता है?",
  ...
  },
  {
    ...
    options_hi: [
      "स्थिर चौड़ाई",
      "स्क्रीन आकार के अनुसार बदलता है",
      "केंद्रित टेक्स्ट",
      "उत्तरदायी रंग",
    ],
  ...
  },
  {
    ...
    question_hi:
      "कौन-सा मीडिया फीचर डिवाइस के आस्पेक्ट अनुपात की जांच करता है?",
  ...
  },
  {
    ...
    question_hi:
      "उत्तरदायी डिज़ाइन का परीक्षण करने के लिए सबसे अच्छा टूल कौन-सा है?",
  ...
  },
  {
    ...
    options_hi: [
      "एनिमेटेड",
      "स्क्रीन आकार के अनुसार समायोजित होता है",
      "तेज़ लोडिंग",
      "सर्वर-आधारित",
    ],
  ...
  },
  {
    ...
    question_hi:
      "उत्तरदायी डिज़ाइन में कितने ब्रेकपॉइंट्स की सिफारिश की जाती है?",
  ...
  },
  {
    ...
    options_en: [
      "Using max-width first",
      "Designing for desktop only",
      "Using min-width first",
      "Using JavaScript media",
    ],
    options_hi: [
      "पहले max-width का उपयोग करना",
      "केवल डेस्कटॉप के लिए डिज़ाइन करना",
      "पहले min-width का उपयोग करना",
      "JavaScript मीडिया का उपयोग करना",
    ],
  ...
  },
  {
    ...
    question_hi:
      "मीडिया क्वेरी में सामान्यतः कौन-सी प्रॉपर्टी समायोजित की जाती है?",
  ...
  },
  {
    ...
    question_hi:
      "निम्न में से कौन उत्तरदायी डिज़ाइन के लिए सर्वोत्तम अभ्यास है?",
    options_en: [
      "Use fixed units",
      "Ignore media queries",
      "Use relative units",
    ...
    options_hi: [
      "फिक्स्ड यूनिट्स का उपयोग करें",
      "मीडिया क्वेरी को अनदेखा करें",
      "रिलेटिव यूनिट्स का उपयोग करें",
      "CSS से बचें",
    ],
  ...
  },
  {
    ...
    question_hi:
      "मीडिया क्वेरी में कौन-सी प्रॉपर्टी फ़ॉन्ट साइज समायोजित करने में मदद करती है?",
  ...
  },
  {
    num: 40,
    question_en:
      "Which of these is important for accessibility in responsive design?",
    question_hi:
      "उत्तरदायी डिज़ाइन में इनमें से कौन एक्सेसिबिलिटी के लिए महत्वपूर्ण है?",
    options_en: [
      "High contrast",
      "Fixed layout",
      "Flashy colors",
  ...
  },
  {
    ...
    options_en: [
      ...
      "Applies when width is ≤ 1200px",
      "Always applies",
      "Only for mobile",
    ],
    options_hi: [
      "न्यूनतम चौड़ाई 1200px",
      "जब चौड़ाई ≤ 1200px हो",
      "हमेशा लागू होता है",
      "केवल मोबाइल के लिए",
    ],
  ...
  },
  {
    num: 43,
    question_en:
      "Which attribute is used in HTML to help with responsive images?",
    question_hi:
      "HTML में उत्तरदायी इमेज के लिए कौन-सा एट्रिब्यूट उपयोग होता है?",
  ...
  },
  {
    ...
    options_en: [
      "Font",
      "Device width and scale",
      "Image size",
      "Animation speed",
    ],
    options_hi: [
      "फ़ॉन्ट",
      "डिवाइस की चौड़ाई और स्केल",
      "इमेज साइज",
      "एनिमेशन स्पीड",
    ],
  ...
  },
  {
    ...
    question_hi:
      "उत्तरदायी डिज़ाइन के लिए सबसे अच्छा लेआउट स्ट्रैटेजी कौन-सा है?",
    options_en: [
      "Fixed layout",
      "Fluid grid",
      "Absolute layout",
  ...
  },
  {
    ...
    question_hi:
      "उत्तरदायी लेआउट के लिए box-sizing का कौन-सा मान बेहतर होता है?",
  ...
  },
  {
    ...
    question_hi:
      "कौन-सी CSS यूनिट स्क्रीन साइज के अनुसार अच्छे से अनुकूल होती है?",
  ...
  },
  {
    ...
    question_hi:
      "मोबाइल उत्तरदायित्व सुनिश्चित करने के लिए कौन-सा टैग उपयोग करें?",
  ...
  },
  {
    ...
    question_hi:
      "कौन-सा width मान एलिमेंट को स्क्रीन के अनुसार समायोजित करता है?",
