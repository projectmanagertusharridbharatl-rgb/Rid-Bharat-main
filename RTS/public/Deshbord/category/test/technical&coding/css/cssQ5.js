const questions = [
  ...
  },
  {
    num: 4,
    question_en:
      "Which property controls the direction of the main axis in flexbox?",
    question_hi:
      "Flexbox में main axis की दिशा को कौन-सी प्रॉपर्टी नियंत्रित करती है?",
    options_en: [
      "flex-direction",
      "justify-content",
      "align-items",
  ...
  },
  {
    num: 5,
    question_en:
      "Which property controls how flex items are aligned along the main axis?",
    question_hi:
      "Main axis के साथ flex आइटम्स को कैसे संरेखित किया जाता है, यह कौन-सी प्रॉपर्टी नियंत्रित करती है?",
    options_en: [
      "justify-content",
      "align-items",
      "flex-direction",
  ...
  },
  {
    ...
    question_hi:
      "Flex आइटम्स के wrapping को कौन-सी प्रॉपर्टी नियंत्रित करती है?",
  ...
  },
  {
    num: 9,
    question_en:
      "Which property is shorthand for 'flex-grow', 'flex-shrink' and 'flex-basis'?",
    question_hi:
      "'flex-grow', 'flex-shrink' और 'flex-basis' के लिए shorthand कौन-सी प्रॉपर्टी है?",
  ...
  },
  {
    ...
    question_hi:
      "क्रॉस एक्सिस पर फ्लेक्स आइटम्स को संरेखित करने वाली प्रॉपर्टी कौन-सी है?",
    options_en: [
      "align-items",
      "justify-content",
      "flex-direction",
  ...
  },
  {
    num: 13,
    question_en:
      "Which property allows individual flex items to override the container’s 'align-items' setting?",
    question_hi:
      "कौन-सी प्रॉपर्टी व्यक्तिगत फ्लेक्स आइटम्स को कंटेनर के 'align-items' सेटिंग को ओवरराइड करने देती है?",
  ...
  },
  {
    num: 14,
    question_en:
      "Which flexbox property controls the alignment of flex lines in multi-line flex containers?",
    question_hi:
      "मल्टी-लाइन फ्लेक्स कंटेनर में फ्लेक्स लाइनों की संरेखण को कौन-सी प्रॉपर्टी नियंत्रित करती है?",
    options_en: [
      "align-content",
      "justify-content",
      "align-items",
  ...
  },
  {
    num: 16,
    question_en:
      "Which CSS property is used to set the initial main size of a flex item?",
    question_hi:
      "कौन-सी CSS प्रॉपर्टी फ्लेक्स आइटम के प्रारंभिक मुख्य आकार को सेट करती है?",
  ...
  },
  {
    ...
    question_hi:
      "'justify-content' का कौन-सा मान आइटम्स को केंद्र में संरेखित करता है?",
  ...
  },
  {
    num: 20,
    question_en:
      "How do you make a flex container wrap its items to the next line?",
    question_hi:
      "फ्लेक्स कंटेनर को अपने आइटम्स को अगली लाइन पर रैप करने के लिए कैसे सेट करें?",
    options_en: [
      "flex-wrap: wrap",
  ...
  },
  {
    num: 22,
    question_en:
      "Which property controls the alignment of flex items when they do not use all the available space?",
    question_hi:
      "जब फ्लेक्स आइटम्स उपलब्ध जगह का पूरा उपयोग नहीं करते, तो उनकी संरेखण को कौन-सी प्रॉपर्टी नियंत्रित करती है?",
  ...
  },
  {
    num: 23,
    question_en:
      "Which property is used to change the order of flex items visually?",
    question_hi:
      "फ्लेक्स आइटम्स के दृश्य क्रम को बदलने के लिए कौन-सी प्रॉपर्टी का उपयोग किया जाता है?",
  ...
  },
  {
    num: 25,
    question_en:
      "Which CSS flexbox property controls the ability of a flex item to shrink if necessary?",
    question_hi:
      "कौन-सी CSS फ्लेक्सबॉक्स प्रॉपर्टी फ्लेक्स आइटम को आवश्यक होने पर सिकुड़ने की क्षमता नियंत्रित करती है?",
  ...
  },
  {
    num: 27,
    question_en:
      "Which property defines the default size of an element before remaining space is distributed?",
    question_hi:
      "कौन-सी प्रॉपर्टी किसी एलिमेंट के डिफ़ॉल्ट आकार को परिभाषित करती है जब तक कि बाकी स्थान वितरित न हो?",
  ...
  },
  {
    ...
    question_hi:
      "'justify-content: center' एक फ्लेक्स कंटेनर में क्या करता है?",
    options_en: [
    ...
    options_hi: [
      "मुख्य अक्ष के केंद्र में आइटम संरेखित करता है",
      "प्रारंभ में आइटम संरेखित करता है",
      "अंत में आइटम संरेखित करता है",
      "आइटम्स को फैलाता है",
    ],
  ...
  },
  {
    ...
    question_hi:
      "कौन-सी प्रॉपर्टी फ्लेक्स कंटेनर में आइटम्स को रैप करने की अनुमति देती है?",
  ...
  },
  {
    num: 30,
    question_en:
      "What value of 'flex-direction' makes the main axis vertical from top to bottom?",
    question_hi:
      "'flex-direction' का कौन-सा मान मुख्य अक्ष को ऊपर से नीचे तक लंबवत बनाता है?",
  ...
  },
  {
    num: 31,
    question_en:
      "Which CSS property is used to align items on the cross axis in a flex container?",
    question_hi:
      "फ्लेक्स कंटेनर में क्रॉस अक्ष पर आइटम को संरेखित करने के लिए कौन-सी CSS प्रॉपर्टी उपयोग की जाती है?",
    options_en: [
      "justify-content",
      "align-items",
      "flex-direction",
  ...
  },
  {
    num: 32,
    question_en:
      "Which value of 'justify-content' places items at the start of the main axis?",
    question_hi:
      "'justify-content' का कौन-सा मान आइटम्स को मुख्य अक्ष की शुरुआत में रखता है?",
  ...
  },
  {
    num: 33,
    question_en:
      "Which property allows items to wrap onto multiple lines in a flex container?",
    question_hi:
      "फ्लेक्स कंटेनर में आइटम्स को कई लाइनों में लपेटने की अनुमति देने वाली प्रॉपर्टी कौन-सी है?",
  ...
  },
  {
    num: 34,
    question_en:
      "Which value of 'align-items' aligns items at the end of the cross axis?",
    question_hi:
      "'align-items' का कौन-सा मान आइटम्स को क्रॉस अक्ष के अंत में संरेखित करता है?",
  ...
  },
  {
    num: 36,
    question_en:
      "Which value of 'flex-direction' sets the main axis horizontally from right to left?",
    question_hi:
      "'flex-direction' का कौन-सा मान मुख्य अक्ष को दाएँ से बाएँ क्षैतिज बनाता है?",
  ...
  },
  {
    ...
    question_hi:
      "'align-items' का कौन-सा मान आइटम्स को कंटेनर भरने के लिए खींचता है?",
  ...
  },
  {
    num: 39,
    question_en:
      "Which CSS property sets how flex items are laid out along the main axis?",
    question_hi:
      "कौन-सी CSS प्रॉपर्टी निर्धारित करती है कि फ्लेक्स आइटम्स मुख्य अक्ष के साथ कैसे रखे जाते हैं?",
  ...
  },
  {
    num: 40,
    question_en:
      "Which property sets the order in which items appear in the flex container?",
    question_hi:
      "कौन-सी प्रॉपर्टी फ्लेक्स कंटेनर में आइटम्स की उपस्थिति का क्रम सेट करती है?",
  ...
  },
  {
    ...
    question_hi:
      "कौन-सी शॉर्टहैंड प्रॉपर्टी 'flex-grow', 'flex-shrink', और 'flex-basis' सेट करती है?",
  ...
  },
  {
    num: 42,
    question_en:
      "Which property defines whether items are forced onto one line or can wrap?",
    question_hi:
      "कौन-सी प्रॉपर्टी निर्धारित करती है कि आइटम्स को एक ही पंक्ति में रखा जाएगा या वे लपेटे जा सकते हैं?",
  ...
  },
  {
    num: 44,
    question_en:
      "Which flexbox property helps to control overflow of flex items?",
    question_hi:
      "कौन-सी फ्लेक्सबॉक्स प्रॉपर्टी फ्लेक्स आइटम्स के ओवरफ्लो को नियंत्रित करने में मदद करती है?",
  ...
  },
  {
    ...
    question_hi:
      "कौन-सी प्रॉपर्टी 'flex-direction' और 'flex-wrap' को जोड़ती है?",
  ...
  },
  {
    num: 48,
    question_en:
      "Which property controls how flex items shrink when necessary?",
    question_hi:
      "कौन-सी प्रॉपर्टी आवश्यक होने पर फ्लेक्स आइटम्स को सिकोड़ने को नियंत्रित करती है?",
  ...
  },
  {
    num: 49,
    question_en:
      "Which flexbox value centers items both vertically and horizontally?",
    question_hi:
      "कौन-सा फ्लेक्सबॉक्स मान आइटम्स को ऊर्ध्वाधर और क्षैतिज दोनों रूप से केंद्र में रखता है?",
    options_en: [
