const questions = [
  {
    ...
    options_en: ["Temperature", "Dissociation/association", "Pressure", "Viscosity"],
  ...
  },
  {
    ...
    question_hi: "SN1 अभिक्रिया proceed via which intermediate?",
  ...
  },
  {
    ...
    question_hi: "कौन सा reagent एक strong oxidizing agent है?",
  ...
  },
  {
    ...
    question_hi: "कौन सी अभिक्रिया alkene को alkane में convert करती है?",
    options_en: ["Halogenation", "Dehydrogenation", "Hydrogenation", "Dehydration"],
  ...
  },
  {
    ...
    question_hi: "KMnO4 solution का रंग क्या होता है?",
  ...
  },
  {
    ...
    question_hi: "Bohr model किस atom पर सबसे अच्छा लागू होता है?",
  ...
  },
  {
    ...
    question_hi: "Bond enthalpy सामान्यतः किन bonds के टूटने को संदर्भित करती है?",
    options_en: [
  ...
  },
  {
    ...
    question_hi: "Markovnikov rule HX के addition पर किस पर लागू होता है?",
    options_en: ["Aromatic rings", "Alkynes always", "Alkenes", "Alkanes"],
    answer_en: "Alkenes",
    attempted: false,
    selected: "",
  },
  {
    ...
    question_hi: "Avogadro's number लगभग कितना होता है?",
  ...
  },
  {
    ...
    question_hi: "Alkanes का सामान्य सूत्र क्या है?",
  ...
  },
  {
    num: 16,
    question_en: "Electron configuration of O atom (ground state)",
    question_hi: "O atom का ground state इलेक्ट्रॉन विन्यास क्या है?",
    options_en: ["1s2 2s2 2p3", "1s2 2s2 2p4", "1s2 2s1 2p4", "1s2 2s2 2p6"],
    answer_en: "1s2 2s2 2p4",
    attempted: false,
    selected: "",
  },
  {
    ...
    question_hi: "Zn के dilute HCl से अभिक्रिया करने पर कौन सी गैस निकलती है?",
  ...
  },
  {
    ...
    question_hi: "Benzene किस प्रकार की अभिक्रिया करता है?",
    options_en: [
      "Elimination",
  ...
  },
  {
    ...
    question_hi: "Ideal गैस के लिए compressibility factor Z का मान क्या है?",
    options_en: ["Infinity", "1", "0", "2"],
    answer_en: "1",
    attempted: false,
    selected: "",
  },
  {
    ...
    question_hi: "Conjugated system का उदाहरण कौन सा है?",
  ...
  },
  {
    ...
    question_hi: "Radical द्वारा शुरू की गई अभिक्रियाएँ किस initiator का उपयोग करती हैं?",
    options_en: ["Acids", "Water", "Peroxides", "Bases"],
    answer_en: "Peroxides",
    attempted: false,
    selected: "",
  },
  {
    num: 22,
    question_en: "Which is an example of a conjugated system",
    question_hi: "Conjugated system का एक उदाहरण कौन सा है?",
  ...
  },
  {
    ...
    question_hi: "कौन सा oxide amphoteric होता है?",
  ...
  },
  {
    ...
    question_hi: "कौन सा compound aromatic है?",
  ...
  },
  {
    num: 25,
    question_en: "Reactions initiated by radicals often use which initiator",
    question_hi: "Radical initiated reactions में कौन सा initiator उपयोग होता है?",
  ...
  },
  {
    ...
    question_hi: "Coordination chemistry में typical ligand कौन सा है?",
    options_en: ["He", "NH3", "Na+", "Cl-"],
    answer_en: "NH3",
    attempted: false,
    selected: "",
  },
  ...
  },
  {
    ...
    question_en: "Markovnikov rule applies to addition of HX to",
    question_hi: "Markovnikov rule HX के addition पर किस पर लागू होता है?",
    options_en: ["Alkynes always", "Alkanes", "Alkenes", "Aromatic rings"],
    answer_en: "Alkenes",
    attempted: false,
    selected: "",
  },
  {
    ...
    question_hi: "BF3 में central atom का hybridization क्या है?",
    options_en: ["sp3", "sp2", "sp3d", "sp"],
    answer_en: "sp2",
    attempted: false,
    selected: "",
  },
  {
    ...
    question_hi: "STP पर 1 mole ideal gas लगभग कितना आयतन घेरती है?",
    options_en: ["1.0 L", "22.4 L", "11.2 L", "44.8 L"],
    answer_en: "22.4 L",
    attempted: false,
    selected: "",
  },
  {
    ...
    question_hi: "Osmotic pressure π (dilute) किसके बराबर होती है?",
  ...
  },
  {
    ...
    question_en: "Markovnikov rule applies to addition of HX to",
    question_hi: "Markovnikov rule HX के addition पर किस पर लागू होता है?",
    options_en: ["Alkenes", "Alkanes", "Alkynes always", "Aromatic rings"],
    answer_en: "Alkenes",
    attempted: false,
    selected: "",
  },
  {
    ...
    question_hi: "Freezing point depression ΔTf किसके समानुपाती है?",
  ...
  },
  {
    ...
    question_hi: "Raoult's law किस पर लागू होती है?",
    options_en: ["Non-ideal solutions", "Pure solvents", "Colloids", "Ideal solutions"],
  ...
  },
  {
    num: 39,
    question_en: "Electron configuration of O atom (ground state)",
    question_hi: "O atom का ground state electron configuration क्या है?",
    options_en: ["1s2 2s1 2p4", "1s2 2s2 2p3", "1s2 2s2 2p6", "1s2 2s2 2p4"],
    answer_en: "1s2 2s2 2p4",
    attempted: false,
    selected: "",
  },
  {
    num: 40,
    question_en: "Which oxide is amphoteric",
    question_hi: "कौन सा oxide amphoteric है?",
  ...
  },
  {
    ...
    question_hi: "ΔG < 0 होने पर प्रक्रिया कैसी होती है?",
    options_en: ["Impossible", "Spontaneous", "Non-spontaneous", "At equilibrium"],
  ...
  },
  {
    ...
    question_hi: "कौन सी अभिक्रिया carbon की oxidation state बढ़ाती है?",
    options_en: ["Substitution", "Oxidation", "Isomerization", "Reduction"],
    answer_en: "Oxidation",
    attempted: false,
    selected: "",
  },
  {
    num: 43,
    question_en: "Reactions initiated by radicals often use which initiator",
    question_hi: "Radical reactions में किस initiator का उपयोग होता है?",
  ...
  },
  {
    ...
    question_en: "Which reaction converts an alkene to an alkane",
    question_hi: "कौन सी अभिक्रिया alkene को alkane में convert करती है?",
    options_en: ["Hydrogenation", "Dehydration", "Halogenation", "Dehydrogenation"],
    answer_en: "Hydrogenation",
    attempted: false,
    selected: "",
  },
  {
    ...
    question_hi: "Arrhenius equation में activation energy और कौन सा factor होता है?",
  ...
  },
  {
    ...
    question_hi: "Ideal gas के लिए Joule-Thomson coefficient कितना होता है?",
  ...
  },
  {
    ...
    question_hi: "Boiling point elevation किस पर निर्भर करता है?",
  ...
  },
  {
    ...
    question_hi: "Critical temperature वह तापमान है जिसके ऊपर गैस",
    options_en: [
      "Becomes plasma",
      "Is ideal",
